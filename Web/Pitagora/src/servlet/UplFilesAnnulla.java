...
public class UplFilesAnnulla extends HttpServlet 
{
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    ...
    out.println("<html>");
    out.println("<head><title>UplFilesAnnulla</title></head>");
    out.println("<body>");
    ...
    //   long maxUploadSize =  1024 * 1024;
      ...
      // Il ServletContext sevir? per ricavare il MIME type del file uploadato
       context = getServletContext();
        ...
        StaticContext.writeLog(StaticMessages.getMessage(5001,"UplFilesAnnulla","","",StaticContext.APP_SERVER_DRIVER));
...
//   mostraOrologio(request,response);
   ...
   if (funzupload != null) { 
          ...
          try   {
              ...
              esito = lCtr_Utility.annullaTuttoMassivo();
              context = getServletContext();
          }
          catch(Exception lexc_Exception){
            System.err.println("doPost.Upload 1: "+lexc_Exception.toString());
          ...
          out.println("  <tr>                                                                                                                                                                                     ");
          out.println("       <td align=\"left\"><img src=\""  + request.getContextPath() +  "/utility/images/AnnullaTutto.gif\" alt=\"\" border=\"0\"></td>                                                                                                       ");
          out.println("  </tr>                                                                                                                                                                                    ");
          out.println("</table>                                                                                                                                                                                   ");
          ...
          out.println("                    <input class=\"textB\" title=\"Indietro\" type=\"button\" maxlength=\"30\" name=\"Indietro\" bgcolor=\"<%=StaticContext.bgColorFooter%>\" value=\"Indietro\" onClick=\"window.location.href='utility/jsp/ann_tutto_mas.jsp'\">");
          out.println("                </td>                                                              ");
          out.println("            </tr>    ");
          out.println("                </table>                                                                                                                                                                       ");
          out.println("               </td>                                                                                                                                                                           ");
...
/*       try   {
           ...
           esito = lCtr_Utility.truncateAnnullaTutto();
...
*/
       ...
       while((line = reader.readLine())!= null){
           ...
           try   {
               ...
               esito = lCtr_Utility.insertAnnullaTutto(line.replaceAll(";",""));
               context = getServletContext();
           }
           catch(Exception lexc_Exception){
             System.err.println("doPost.Upload 1: "+lexc_Exception.toString());
  ...
  private void redirect(HttpServletRequest request, HttpServletResponse response, int i ) throws IOException
  {
    ...
    out.println("	    function carica() { frmDati.action=\"UplFilesAnnulla\"; frmDati.ENCTYPE=\"multipart/form-data\"; frmDati.submit();  }");
    out.println("</SCRIPT>");	    
    ...
    if ( 1 == i ) {
      ...
      out.println("            </tr>    ");
	    ...
	    out.println("                    <input class=\"textB\" title=\"Ricerca\" type=\"button\" maxlength=\"30\" name=\"Esci\" bgcolor=\"<%=StaticContext.bgColorFooter%>\" value=\"Esci\" onClick=\"window.location.href='utility/jsp/ann_tutto_mas.jsp'\">");
	    out.println("                </td>                                                              ");
	    out.println("            </tr>    ");
*/
