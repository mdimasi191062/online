...
public class GestAssOfPsBMPPK extends AbstractPK 
{
  ...
  public GestAssOfPsBMPPK()
  {
  }


  public GestAssOfPsBMPPK(String codPs,String codOf,String dataIniOfPs,String dataIniPs)
  {
    this.codPs=codPs;
    this.codOf=codOf;
