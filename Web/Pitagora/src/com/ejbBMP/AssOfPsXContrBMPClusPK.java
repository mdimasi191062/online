...
public class AssOfPsXContrBMPClusPK implements Serializable 
{
  ...
  public AssOfPsXContrBMPClusPK()
  {
  }

  public AssOfPsXContrBMPClusPK(String codePs,String descPs,String dataIni,String dataFine,String codeOf,String descOf,String dataIniOf,String dataFineOf,String codeCOf,String descCOf,String dataIniOfPs,String dataFineOfPs,String codeFreq,String descFreq,String codeModal,String descModal,String tipoFlgAP,
                            int qntaShiftCanoni,String codeTipoContr, String flagSys,String codeContr, String descContr, String dataIniContr, String codeCluster, String tipoCluster)
  {
  this.codePs=codePs;
  this.descPs=descPs;
  ...
  public void setCodeCluster(String s)
    {this.codeCluster=s;}

  public String getTipoCluster()
    {return this.tipoCluster;}

  public void setTipoCluster(String s)
    {this.tipoCluster=s;}
