...
public class Action_J2_LstOperatoriClassic  implements ActionInterface
{
  public Action_J2_LstOperatoriClassic()
  {
  }
  public String esegui(HttpServletRequest request, HttpServletResponse response) throws Exception
  {
          ...
          Vector vec=home.create().getOperatoriClassic(lista_servizi);
