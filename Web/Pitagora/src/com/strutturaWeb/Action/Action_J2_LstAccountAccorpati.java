...
public class Action_J2_LstAccountAccorpati  implements ActionInterface
{
  public Action_J2_LstAccountAccorpati()
  {
  }
  public String esegui(HttpServletRequest request, HttpServletResponse response) throws Exception
  {
    ...
    Vector vec=home.create().getPreAccorpati(code_accorpante);
