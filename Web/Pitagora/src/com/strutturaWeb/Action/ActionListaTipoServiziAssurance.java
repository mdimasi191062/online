...
public class ActionListaTipoServiziAssurance implements ActionInterface
{
  public ActionListaTipoServiziAssurance()
  {
  }
   public String esegui(HttpServletRequest request, HttpServletResponse response) throws Exception
  {
     ...
     ViewGenerica view=new ViewGenerica(home.create().getTipiServiziAssurance());
