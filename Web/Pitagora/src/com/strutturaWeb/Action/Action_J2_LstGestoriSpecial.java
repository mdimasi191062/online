...
public class Action_J2_LstGestoriSpecial  implements ActionInterface
{
  public Action_J2_LstGestoriSpecial()
  {
  }
  public String esegui(HttpServletRequest request, HttpServletResponse response) throws Exception
  {
          String code_tipo_contr = request.getParameter("code_servizio");
          ...
          Vector vec=home.create().getGestoriSpecial(code_tipo_contr);
