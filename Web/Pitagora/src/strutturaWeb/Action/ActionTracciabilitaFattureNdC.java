...
public class ActionTracciabilitaFattureNdC implements ActionInterface
{
  public ActionTracciabilitaFattureNdC()
  {
  }
  ...
  public String esegui(HttpServletRequest request, HttpServletResponse response) throws Exception
  {
    ...
    if(!i_dataDRO.equals("null"))
    {
      try
      {
        try
        {
           Date dataDRO = df.parse(i_dataDRO);
           
        }catch (ParseException e)
        {
          throw new Exception("La data DRO deve essere valorizzata!");
        }
    ...
    //  codiceTipoContratto=1 codeFunz=30 id_funz=7   <---- nostro caso.
