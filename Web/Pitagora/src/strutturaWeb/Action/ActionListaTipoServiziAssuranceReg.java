...
public class ActionListaTipoServiziAssuranceReg implements ActionInterface
{
  public ActionListaTipoServiziAssuranceReg()
  {
  }
   public String esegui(HttpServletRequest request, HttpServletResponse response) throws Exception
  {
     ...
     ViewGenerica view=new ViewGenerica(home.create().getTipiServiziAssuranceReg());
