...
public class ActionlistaTipoGestoreAssurance implements ActionInterface
{
  public ActionlistaTipoGestoreAssurance()
  {
  }
   public String esegui(HttpServletRequest request, HttpServletResponse response) throws Exception
  {
     ...
     ViewGenerica view=new ViewGenerica(home.create().getTipiGestoreAssurance());
