...
function aggiornaElencoFile(codiceFunzione)
{
 ...
 if (indiceCiclo > 0 && indicecomboServizio > 0)
 {
    var appociclo = document.formPag.ciclo.options[indiceCiclo].text;
    
    var apposervizio = document.formPag.comboServizio.options[indicecomboServizio].value;
...
<body onload="ElencoFile('DOWNLOAD_JPUB2')">
    ...
    <td>
        ...
        <tr height="35px">
                    ...
                    <td bgcolor="<%=StaticContext.bgColorTabellaGenerale%>"> 
                      <Select name="ciclo" id="ciclo" class="text" label="Ciclo di riferimento" onchange="aggiornaElencoFile('DOWNLOAD_JPUB2');">
                      <%
                    ...
                    <td class="textB" width="20%">Servizio</td>
                    <td width="80%">
                        <select name="comboServizio" id="comboServizio" width="10px" class="text" onchange="aggiornaElencoFile('DOWNLOAD_JPUB2');">
                            <option value="0" selected=true>Selezionare Tipogia</option>
                            <option value="1">rpvd</option>
                            <option value="2">mp</option>
                            <option value="3">itc</option>
                            <option value="4">itc_rev</option>
                            <option value="5">pp</option>
                            <option value="6">atm</option>
                            <option value="7">SAP</option>
                            <option value="8">SWN</option>
                        </select>
                    </td>
       </tr>
        <tr HEIGHT='15px'>
