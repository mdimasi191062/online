...
<%	String strTestate = Misc.nh(request.getParameter("rdTestate"));// o 0 o 1
	String strDataInizioCiclo = Misc.nh(request.getParameter("txtDataInizioCiclo"));
	...
	<% 	strLogMessage = "remoteCtr_Batch.LancioBatch_ExportPerSap:(strCodeUtente=" + strCodeUtente + ";strTestate=" + strTestate + ";strDataInizioCiclo=" + strDataInizioCiclo + ";strDataFineCiclo=" + strDataFineCiclo + ";strDataFinePeriodo=" + strDataFinePeriodo + ";)";%>
	<logtag:logData id="<%= ((clsInfoUser)session.getAttribute(StaticContext.ATTRIBUTE_USER)).getUserName() %>">
			<%=StaticMessages.getMessage(3501,strLogMessage)%>
	</logtag:logData>
	<%
	lstr_Messagge = remoteCtr_Batch.LancioBatch_ExportPerSap(strCodeUtente,
												 strTestate,
												 strDataInizioCiclo,
												 strDataFineCiclo,
                                                 strDataFinePeriodo);
