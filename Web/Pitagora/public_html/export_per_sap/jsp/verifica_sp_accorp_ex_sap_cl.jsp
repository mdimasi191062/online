...
<%=StaticMessages.getMessage(3006,"verifica_sp_accorp_ex_sap_cl.jsp")%>
</logtag:logData>
...
String strNameFirstPage = "verifica_sp_accorp_ex_sap_cl.jsp";
strTitle = "Verifica Lancio SP Accorpamento";
strCodeFunz = StaticContext.RIBES_LANCIO_PKG;
strCodeFunzPkg = StaticContext.PKG_ACCORP_X_SAP;
			...
			<table width="90%" cellspacing="1" align="center">
				<%
					...
					// carico il vettore
					  ...
					  {
					    vctBatch = (Vector)remoteEnt_ExportPerSap.getElabBatchVerificaSpAccorp(strCodeFunz,strCodeFunzPkg);
					    if (vctBatch!=null)
