...
<%@ page import="javax.rmi.*,com.ejbBMP.*,com.ejbSTL.*,com.utl.*,com.usr.*,java.util.Collection" %>
<%@ page errorPage = "/common/jsp/TrackingErrorPage.jsp"%>
<sec:ChkUserAuth  />
<logtag:logData id="<%= ((clsInfoUser)session.getAttribute(StaticContext.ATTRIBUTE_USER)).getUserName() %>">
<%=StaticMessages.getMessage(3006,"cbn1_ver_calcolo_penali_cl.jsp")%>
</logtag:logData>
...
<%
    rowPARAM_VALORIZ =  remote_PARAM_VALORIZ_CL.CicloDiFatturazione_CPM(codiceTipoContratto);
...
<%
     collection = home.findAll_CPM(rowPARAM_VALORIZ.getData_inizio_ciclo_fatrz(),rowPARAM_VALORIZ.getData_fine_ciclo_fatrz());      
...
<form name="frmSearch" onsubmit="submitFrmSearch('0');return false" method="post" action="cbn1_ver_calcolo_penali_cl.jsp">
<table align=center width="90%" border="0" cellspacing="0" cellpadding="0">
  ...
  <!-- Gestione navigazione-->
<form name="frmDati" method="post" action='cbn1_ver_cpm_lista_account_cl.jsp'>
        <tr>
          <td>
