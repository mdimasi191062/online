...
<%=StaticMessages.getMessage(3006,"accordiTransattivi.jsp")%>
</logtag:logData>
<%
String strCheckCess ="";
%>
...
function ONESEGUI(){
  ...
  var selServizio;
    ...
    for(var i=0;i<document.formPag.optServizi.length;i++){
      if(document.formPag.optServizi[i].checked){
        selServizio = document.formPag.optServizi[i].value;
        break;
      }
    }
  ...
  if(lancio==0)
  {
    ...
    //var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz=18&checkUnaTantum='+checkUnaTantum; 
    //var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz=23'; 
var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz='+selServizio; 
...
*/
   ...
   function dataCongelamento() {     
           if(document.formPag.codeDataCongelamento.value == '0')  {
                 ...
                 document.formPag.chkUnaTantum.disabled=true;
...
<table align=center width="90%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><img src="../images/accordi_transattivi.gif" alt="" border="0"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>
      <table width="95%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
              ...
              <tr>
                <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Accordi Transattivi</td>
      ...
      <table width="85%" border="0" cellspacing="0" cellpadding="3" align='center' bgcolor="<%=StaticContext.bgColorTabellaGenerale%>">
       ...
       <tr>
          <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="41%">&nbsp;Servizi</td>
        ...
        <tr>
          <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="23" checked >Wlr             
            </TD>
        </tr>
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="28"  >Vull
            </TD>
        </tr>
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="29"  >Vula
            </TD>
        </tr>        
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="33"  >Ull
            </TD>
        </tr>        
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="34"  >UllDati
            </TD>
        </tr>             
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="30"  >Slu
            </TD>
        </tr>               
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="31"  >SharedAccess
            </TD>
        </tr>               
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="32"  >BsSpecialProfile
            </TD>
        </tr>               
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="35"  >BsNga
            </TD>
        </tr>               
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="27"  >BsGbe
            </TD>
        </tr>                       
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="25"  >BsBasePlus
            </TD>
        </tr>                       
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="26"  >BsAtm
            </TD>
        </tr>                       
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optServizi" value="24"  >Cps
            </TD>
        </tr>                       
