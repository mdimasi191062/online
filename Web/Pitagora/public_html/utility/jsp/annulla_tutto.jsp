...
<logtag:logData id="<%= ((clsInfoUser)session.getAttribute(StaticContext.ATTRIBUTE_USER)).getUserName() %>">
  <%=StaticMessages.getMessage(3006,"annulla_tutto.jsp")%>
</logtag:logData>
...
{ 
        ...
        document.frmDati.action = "annulla_tutto.jsp?operazione=1";
...
<tr>
  <td>
        ...
        <tr height="35px">
            <td class="textB">Codice Account: </td>
            <td  class="text">
                <input class="text" type='text' name='txtCodiceAccount' obbligatorio="si" value=''  >
            </td>
       </tr>
        <tr height="35px">
            <td class="textB">Codice Istanza PS: </td>
            <td  class="text">
                <input class="text" type='text' name='txtCodiceIstanza'  obbligatorio="si" value=''  >
            </td>
       </tr>    
       <tr height="35px">
            <td class="textB">Data Inizio Fatturazione: </td>
            <td class="text">
                <input type='text' name='txtDataInizioFatt' obbligatorio="si" value='' class="text" readonly >
                <a href="javascript:showCalendar('frmDati.txtDataInizioFatt','');" onMouseOver="javascript:showMessage('seleziona'); return true;" onMouseOut="status='';return true"><img name='imgCalendar1' src="<%=StaticContext.PH_COMMON_IMAGES%>calendario.gif" border="0"></a>
		<a href="javascript:clearField(objForm.txtDataInizioFatt);" onMouseOver="javascript:showMessage('cancella');  return true;" onMouseOut="status='';return true"><img name='imgCancel1'   src="<%=StaticContext.PH_COMMON_IMAGES%>cancella.gif"   border="0"></a>
            </td>
       </tr>     
       <tr height="35px">
            <td class="textB">Data Chiusura Acquisizione Fatturazione: </td>
            <td class="text">
                <input type='text' name='txtDataFineAcq' obbligatorio="si" value='' class="text" readonly >
                <a href="javascript:showCalendar('frmDati.txtDataFineAcq','');" onMouseOver="javascript:showMessage('seleziona'); return true;" onMouseOut="status='';return true"><img name='imgCalendar1' src="<%=StaticContext.PH_COMMON_IMAGES%>calendario.gif" border="0"></a>
