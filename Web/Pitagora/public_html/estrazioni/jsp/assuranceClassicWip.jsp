...
<%=StaticMessages.getMessage(3006,"assuranceSpecWip.jsp")%>
</logtag:logData>
<%
String strCheckCess ="";
%>
...
function ONESEGUI(){
  ...
  var checkUnaTantum = '1';
  var checkCessate = '1';
  var checkHD = '1';
  var checkAnagrafica = '1';  

    for(var i=0;i<document.formPag.optUnaTantum.length;i++){
      if(document.formPag.optUnaTantum[i].checked){
        checkUnaTantum = document.formPag.optUnaTantum[i].value;
        break;
      }
    }
  ...
  if(lancio==0)
  {
    ...
    var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz=19&checkUnaTantum='+checkUnaTantum; 
  ...
  <tr>
    <td>
      <table width="95%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
              ...
              <tr>
                <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Assurance Classic Wip</td>
      ...
      <table width="85%" border="0" cellspacing="0" cellpadding="3" align='center' bgcolor="<%=StaticContext.bgColorTabellaGenerale%>">
       ...
       <tr>
          <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="41%">&nbsp;Flag Unatantum / Bimestrale</td>
        ...
        <tr>
          <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optUnaTantum" value="1" checked >Una Tantum             
            </TD>
        </tr>
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="radio" name="optUnaTantum" value="0"  >Bimestrale
            </TD>
        </tr>        
