...
<%=StaticMessages.getMessage(3006,"int_a_vuoto.jsp")%>
</logtag:logData>
<%
String strCheckCess ="";
%>
...
function ONESEGUI(){
  ...
  var lancio=0;
  var chkAssurance = '1';
  var chkProvisioning = '1';

  if(!document.formPag.chkAssurance.checked && !document.formPag.chkProvisioning.checked) {
       alert("Selezionare almeno un filtro!");
       lancio=1;
  } else {
       if(!document.formPag.chkAssurance.checked)
            chkAssurance = '0';
       if(!document.formPag.chkProvisioning.checked)
            chkProvisioning = '0';
  }
  ...
  if(lancio==0)
  {
    ...
    var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz=37&chkAssurance='+chkAssurance+'&chkProvisioning='+chkProvisioning; 
    ...
    <td>
      ...
      <table width="85%" border="0" cellspacing="0" cellpadding="3" align='center' bgcolor="<%=StaticContext.bgColorTabellaGenerale%>">
        <tr HEIGHT='17px' >
          ...
          <td width="90%"> 
                <div class="textB" name="txtDataCongelamento" id="txtDataCongelamento" align='left' style="visibility:hidden;display:none" align="left"> 
                </div> 
       ...
       <tr>
          <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="41%">&nbsp;Filtro Assurance / Provisioning</td>
        ...
        <tr>
          <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="checkbox" name="chkAssurance" id="chkAssurance" value=''  >Assurance  
            </TD>
        </tr>
        <tr>
            <TD class="text" nowrap align="left" colspan="4">
              <INPUT  type="checkbox" name="chkProvisioning" id="chkProvisioning" value=''  >Provisioning
            </TD>
        </tr>
