...
<EJB:useHome id="homeEnt_PromoAree" type="com.ejbSTL.Ent_PromoAreeHome" location="Ent_PromoAree" />
<EJB:useBean id="remoteEnt_PromoAree" type="com.ejbSTL.Ent_PromoAree" scope="session">
    <EJB:createBean instance="<%=homeEnt_PromoAree.create()%>" />
</EJB:useBean>
...
//GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  else
  {
    //accountVector = remoteEnt_Inventari.getAccount(Code_Servizio);
     accountVectorS = remoteEnt_PromoAree.getAccountByCodeTipoContr(Code_Servizio);
...
function ChangeSel(codiceaccount,descaccount,indice)
{
...
{
  var stringa="";
  var URLParam = '?Servizio=' + '<%=Code_Servizio%>'+'&CodAccountSel='+objForm.CodAccountSel.value;
...
function SubmitSeleziona()
{
  ...
  {
    opener.frmSearch.txtCodeAccount.value = objForm.CodAccountSel.value;
    opener.frmSearch.txtDescAccount.value = objForm.DescAccountSel.value;
    self.close();
  }
}
function CancelMe()
...
%>
                                            ...
                                            <input type='checkbox' checked name='SelAccount' value='<%=myelement.getDESC_ACCOUNT()%>' onclick="ChangeSel('<%=myelement.getCODE_ACCOUNT()%>','<%=myelement.getDESC_ACCOUNT()%>','<%=i%>')">
<%
          }
          else
          {
%>
                                            ...
                                            <input bgcolor='<%=StaticContext.bgColorCellaBianca%>'  type='checkbox' name='SelAccount' value='<%=myelement.getDESC_ACCOUNT()%>' onclick="ChangeSel('<%=myelement.getCODE_ACCOUNT()%>','<%=myelement.getDESC_ACCOUNT()%>','<%=i%>')">
<%
          }
%>
                                        </td>
