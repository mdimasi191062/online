...
<%=StaticMessages.getMessage(3006,"assuranceReg.jsp")%>
</logtag:logData>
<%
//String strCheckCess ="";
%>
...
//    var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz=15&codeTipoContr='+listaServizi+'&codeGestore='+gestore+'&dataCongelamento='+dataCongelamento+'&checkAttive='+checkAttive+'&checkCessate='+checkCessate; 
    var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz=17&codeTipoContr='+listaServizi+'&dataCongelamento='+dataCongelamento+'&checkAttive='+checkAttive+'&checkCessate='+checkCessate; 
  ...
  <tr>
    <td>
      <table width="95%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
              ...
              <tr>
                <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Assurance Regolatorio</td>
      ...
      <table width="85%" border="0" cellspacing="0" cellpadding="3" align='center' bgcolor="<%=StaticContext.bgColorTabellaGenerale%>">
        <tr HEIGHT='35px'>
          <!--td class="textB" width="20%" align="center">Data Ultimo Congelamento</td-->
          <td width="100%"> 
                <div class="textB" name="txtDataCongelamento" id="txtDataCongelamento" align='center' style="visibility:display;display:inline;margin-top: 6px;" align="left"> 
                </div> 
...
-->        
        ...
        <tr>
          <td class="textB" width="80%" align=center>
           Attive <input type='checkbox' name='chkAttive' value='' checked ="checked">
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           Cessate <input type='checkbox' name='chkCessate' value='' checked ="checked">   
          </td>
