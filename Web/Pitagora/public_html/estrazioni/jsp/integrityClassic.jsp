...
<%=StaticMessages.getMessage(3006,"integrityClassic.jsp")%>
</logtag:logData>
<%
String strCheckCess ="";
%>
...
function ONESEGUI(){
  ...
  if(lancio==0)
  {
    ...
    var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz=14&checkAntePost='+checkAntePost; 
  ...
  <tr>
    <td>
      <table width="95%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
              ...
              <tr>
                <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Revenue Integrity Classic</td>
