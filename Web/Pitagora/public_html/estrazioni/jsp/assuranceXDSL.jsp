...
<%=StaticMessages.getMessage(3006,"assuranceXDSL.jsp")%>
</logtag:logData>
<%
//String strCheckCess ="";
%>
...
//    var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz=15&codeTipoContr='+listaServizi+'&codeGestore='+gestore+'&dataCongelamento='+dataCongelamento+'&checkAttive='+checkAttive+'&checkCessate='+checkCessate; 
    var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz=16&codeTipoContr='+listaServizi+'&dataCongelamento='+dataCongelamento+'&checkAttive='+checkAttive+'&checkCessate='+checkCessate; 
  ...
  <tr>
    <td>
      <table width="95%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
              ...
              <tr>
                <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Assurance XDSL</td>
