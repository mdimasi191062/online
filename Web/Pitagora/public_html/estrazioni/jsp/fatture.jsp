...
<%=StaticMessages.getMessage(3006,"fatture.jsp")%>
</logtag:logData>
<%
String strMinCiclo = "";
String strMaxCiclo = "";
 ...
 function checkEndUpload()
 {
    var riga=window["target_upload"].document.body.innerHTML;
      if(riga.endsWith(";</PRE>"))
      {
        ...
        {
           document.formPag.txtRisorse.value+=dati[a].text+"\n";
        } 
        */
...
function impostaDataDRO()
{
    var righe = document.formPag.txtRisorse.value.split("\n");
    if(righe.length>1)
    {
        ...
        clearField(document.formPag.txtDataDRO);
        document.formPag.txtDataDRO.value="Tutte le Date";
        document.formPag.chkDataDRO.checked=true;
        document.formPag.chkDataDRO.disabled=true;
    }
    else
    {
        ...
        document.formPag.chkDataDRO.checked=false;
        document.formPag.chkDataDRO.disabled=false;
        if(document.formPag.txtDataDRO.value=="Tutte le Date")
            clearField(document.formPag.txtDataDRO);
    }
}
...
function ONESEGUI(){
 ...
 var dataDRO=document.formPag.txtDataDRO.value;
 ...
 if(document.formPag.chkDataDRO.checked){
   dataDRO="null";
 }
 ...
 var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz='+id_funz+'&codeTipoContr='+tipoContr+'&codeAccount='+account+'&periodoEstrazione='+periodoEstrazione+'&minCiclo='+TempminCiclo+'&maxCiclo='+TempmaxCiclo+'&aryRisorse='+risorse+'&dataDRO='+dataDRO;
 chiamaRichiesta(sendMessage,'TracciabilitaFattureNdC',asyncFunz);
}
       ...
       <table width="85%" border="0" cellspacing="0" cellpadding="3" align='center' bgcolor="<%=StaticContext.bgColorTabellaGenerale%>">
                    ...
                    <td width="80%">
                      <select name="comboTipoEstraz" width="10px" class="text" >
                        ...
                        <option value="NDC">Nota di Credito</option>
                      </select>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td width="80%">
                      <textarea NAME="txtRisorse" onclick="controllaTesto()" onblur="impostaDataDRO()" onfocus="impostaDataDRO()" id="txtRisorse" COLS="40" ROWS="6" class="text">Inserire un ID Risorsa per riga (manualmente o tramite caricamento di un file txt) .</textarea>
                       <br />
                       <div id="mascheraFile">
              ...
              <tr>
                ...
                <td bgcolor="<%=StaticContext.bgColorCellaBianca%>" class="white" align="center" width="9%"><img src="../../common/images/body/tre.gif" width="28"></td>
                  ...
                  <tr>
                    <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="51%">&nbsp;Filtro Data DRO</td>
                    <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="30%"></td>
                    <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="10%"></td>
                    <td bgcolor="<%=StaticContext.bgColorCellaBianca%>" class="white" align="center" width="9%"><img src="../../common/images/body/tre.gif" width="28"></td>
                  </tr>
                  <tr HEIGHT='35px'>
										<td class="textB">Data DRO</td>
                    <td class="text">
											<input type='text' name='txtDataDRO' value='<%=strDataDRO%>' class="text" readonly="">
											<a href="javascript:showCalendar('formPag.txtDataDRO','');" onMouseOut="status='';return true"><img name='imgCalendar3' src="<%=StaticContext.PH_COMMON_IMAGES%>calendario.gif" border="0"></a>
											<a href="javascript:clearField(formPag.txtDataDRO);" onMouseOut="status='';return true"><img name='imgCancel3'   src="<%=StaticContext.PH_COMMON_IMAGES%>cancella.gif"   border="0"></a>
										</td>
                    <td class="textB">Tutti</td>
                     <td class="textB">
                      <input type='checkbox' name='chkDataDRO' value='<%=strCheckDataDRO%>' onclick="DataDROVisibile();">
                    </td>
                  </tr>
		 	</table>
</table><br>
