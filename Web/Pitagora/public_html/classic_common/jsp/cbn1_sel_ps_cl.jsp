...
<%=StaticMessages.getMessage(3006,"cbn1_sel_ps_cl.jsp")%>
</logtag:logData>
...
function click_SelPs(codice)
{
  objForm.CodPSSel.value=codice;
  objForm.DescSel.value=getRadioButtonValue(objForm.SelPs);
}
...
function SubmitMe()
{
  ...
  {
	opener.dialogWin.returnedValue=objForm.CodPSSel.value+"|"+objForm.DescSel.value;
    objForm.action="<%=StaticContext.PH_CLASSIC_COMMON_JSP%>cbn1_sel_ps_2_cl.jsp?nomeCombo=<%=request.getParameter("nomeCombo")%>";
    objForm.submit();
  }
  else 
  {
                        ...
                        <tr>
                          <td colspan="4">
                                <table border="0" width="100%">
                                    <tr>
                                         <td width="" bordercolor="<%=StaticContext.bgColorRigaDispariTabella%>" class="textB" align="left">&nbsp;Tipo Contratto:&nbsp;</td>
                                         <td width="" class="text" nowrap>&nbsp;<%=strDescTipoContratto%></td>
                                    </tr>
                               		<tr>
                                        ...
                                        <%if(strMostraCliente.equals("")){%>
                                          <td width="" height='18' bordercolor="<%=StaticContext.bgColorRigaDispariTabella%>" class="textB" align="left">&nbsp;Cliente:&nbsp;</td>
                                          <td width="" class="text" nowrap>&nbsp;<%=strCliente%></td>
                                        <%}
										if(strMostraContratto.equals("")){%>
                                          <td width="" bordercolor="<%=StaticContext.bgColorRigaDispariTabella%>" class="textB" align="left">&nbsp;Contratto:&nbsp;</td>
									...
									<tr>
					                      ...
					                      <td  class="text">
					                        <select class="text" name="cboNumRecXPag" onchange="reloadPage('1','cbn1_sel_ps_cl.jsp')">
                    ...
                    <%for(j=((pagerPageNumber.intValue()-1)*intRecXPag);((j < intRecTotali) && (j < pagerPageNumber.intValue()*intRecXPag));j++)	
                      {
                                ...
                                <tr>
                                  <td width='2%' bgcolor="<%=StaticContext.bgColorCellaBianca%>">
                                    <input bgcolor="<%=StaticContext.bgColorCellaBianca%>" type='radio' <%=strChecked%>  name='SelPs' value='<%=lobj_PS.getDESC_ES_PS()%>' onclick="click_SelPs('<%=lobj_PS.getCODE_PS()%>')">
                                  </td>
    ...
    <td>
	    <table width="90%" border="0" cellspacing="0" cellpadding="0" align='center'>
	      ...
	      <tr>
            ...
            <input type=hidden name="CodPSSel" value="<%=codice%>">
            <input type=hidden name="DescSel" value="<%=descrizione%>">
