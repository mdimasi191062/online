...
<%=StaticMessages.getMessage(3006,"verifica_batch_acq_dati_provs.jsp")%>
</logtag:logData>
...
String strNameFirstPage = "verifica_batch_acq_dati_provs.jsp";

strTitle = "Verifica Batch Import Dati Provisioning";
...
<table align='center' width="80%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorTabellaGenerale%>">
	<tr>
		<td width='100%'>
          ...
          {
            //
            vctBatch = remoteEnt_Batch.getElabBatchVerificaProvisioning(intFunzionalita,intAction);
            if (vctBatch!=null)
