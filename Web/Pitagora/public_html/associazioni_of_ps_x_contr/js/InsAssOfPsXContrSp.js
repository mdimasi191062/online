...
{
   //window.alert("clear_all_contratto"); 
...
function handle_ripristina_contratto()
{
}
function handle_change_contratto()
{
 //window.alert(">>> handle_change_contratto");
 if (objForm.msg.value=="")
    clear_contratto_change();
 else
  {
...
function handleReturnedValuePS()
{
 ...
 if (objForm.cod_PS.value==app_cod_Ps)
 ...
 else
  {
   ...
   //if (numeroTariffe>0)
     //  objForm.cmb_contratto[indiceContr].selected=true;
       Enable(objForm.btnPS);    
