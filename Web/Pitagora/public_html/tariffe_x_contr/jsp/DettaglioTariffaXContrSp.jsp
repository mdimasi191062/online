...
String cod_opzione=request.getParameter("cod_opzione"); //modifica opzioni 03-03-03 

String cod_tipo_contratto=request.getParameter("cod_tipo_contratto");
if (cod_tipo_contratto==null) cod_tipo_contratto=(String)session.getAttribute("cod_tipo_contratto");
String des_tipo_contratto=request.getParameter("des_tipo_contratto");
if (des_tipo_contratto==null) des_tipo_contratto=(String)session.getAttribute("des_tipo_contratto");
...
<%
   ...
   else
   {
    ...
    //modifica opzioni 03-03-03 inizio    
      if (cod_opzione=="")
          cod_opzione=null;
      tariffe = homeTariffa.findDettaglio(contrSelez, cod_tar, cod_ogg_fatt, cod_causale, cod_opzione);
      //modifica opzioni 03-03-03 fine  
...
%>
<form name="frmSearch" onsubmit="submitFrmSearch('0');return false" method="GET" action="DettaglioTariffaXContrSp.jsp">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorTabellaGenerale%>">
                    ...
                    <tr>
                      ...
                      <td class="textB" width="25%" colspan='3' align="center">Risultati per pag.:&nbsp;</td>
                        <input class="textB" type="hidden" name="cod_tipo_contratto" value="<%=cod_tipo_contratto%>">
                        <input class="textB" type="hidden" name="des_tipo_contratto" value="<%=des_tipo_contratto%>">
...
<input type="hidden" name="cod_tipo_contratto" id="cod_tipo_contratto" value="<%=cod_tipo_contratto%>">
<input type="hidden" name="des_tipo_contratto" id="des_tipo_contratto" value="<%=des_tipo_contratto%>">
...
<input type="hidden" name=cod_opzione id=cod_opzione value=<%=cod_opzione%>> <!--modifica opzioni 03-03-03-->
<input type="hidden" name=act id=act value="">
  ...
  <%}%>
                ...
                {
                    TariffaXContrBMP obj=(TariffaXContrBMP)objs[i];
                ...
                %>
                       <tr>                                                                                                      
                        <!--MMM 24/10/02 CustomNumberFormat.setToCurrencyFormat(obj.getImpMinSps().toString(),4)-->
