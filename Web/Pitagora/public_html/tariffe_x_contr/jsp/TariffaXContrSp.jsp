...
<%=StaticMessages.getMessage(3007,"Tariffa per cliente contratto")%>
<%=StaticMessages.getMessage(3006,"TariffaXContrSp.jsp")%>
</logtag:logData>
...
<TITLE> Inserimento Nuova Tariffa x contratto</TITLE>
<SCRIPT LANGUAGE="JavaScript" SRC="../../common/js/ControlliNumerici.js"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="../../common/js/openDialog.js"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="../../common/js/calendar.js"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="../../common/js/Common.js"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="../js/TariffaXContrSp.js"></SCRIPT>
...
<%
   ...
   contr=remoteContratto.getContrattiXIns(cod_tipo_contr);
%>   
...
<input type="hidden" name=contrSelez       id=contrSelez         value= "">
<input type="hidden" name=des_contr        id= des_contr         value= "">
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorTabellaForm%>">
                    ...
                    <tr>
                      <td width="49%" class="textB" align="left">&nbsp; Tipo contratto:</td>
                      <td width="1%" class="textB" align="left">&nbsp;</td>
                      <td width="50%" class="textB" align="left">&nbsp;&nbsp;Contratti</td>
                    </tr>
                                        <tr>
                      <td width="49%" class="text"> &nbsp; <%=des_tipo_contr%> </td>
                      <td width="1%" class="textB" align="left">&nbsp;</td>
                   ...
                   <tr>
                    ...
                    <tr>
                      <td  colspan='3'  class="text">
                          ...
                          <input type="button" name="btnPS" value="..." onclick='selezionaPs();'>&nbsp; 
                       </td>
                    </tr>
                  <!--/table-->
                  <!--table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorTabellaForm%>"-->
                    <tr>
                      ...
                      <td  class="text"> &nbsp;</td>
                      <td class="textB" align="left">  <DIV id="causale" >&nbsp; Causale </DIV>                        </td>
                    </tr>
                    <tr>    
					           <td  class="text"> &nbsp;
