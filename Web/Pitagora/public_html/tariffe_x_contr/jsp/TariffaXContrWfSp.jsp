...
<%=StaticMessages.getMessage(3006,"TariffaXContrWfSp.jsp")%>
</logtag:logData>
...
TariffaXContrBMP remoteMaxDataIniOfPsXContr=null;

TariffaBMP       remoteCalcCode=null;
TariffaXContrBMP remoteCalcCodeXContr=null;
...
<EJB:useHome id="home"       type="com.ejbBMP.TariffaBMPHome" location="TariffaBMP" />
    <%
     ...
     data_ini_1 = dataIniTarFormat.parse(dataIniTar); //formato Date
		 remoteMaxDataIniOfPsXContr= homeXContr.findOfMaxDataIniOfPsXContr(contrSelez,oggFattSelez,cod_PS);
     dataIniValAssOfPs= remoteMaxDataIniOfPsXContr.getDataIniValAssOfPs();
     ...
     dataIniValOf1=dataIniValOfFormat.parse(dataIniValOf);
		 ...
		 if (dataIniValAssOfPs1!=null && dataIniValOf1!=null && data_ini_1!=null)
          ...
          numElabBatch=remoteElabBatch.getNumElaborazTrovate().intValue();
					...
					if (numElabBatch==0)
					{
						remoteCalcCodeXContr= homeXContr.findCalcolaCodiceXContr();
            codTar= remoteCalcCodeXContr.getCodTar();
...
if ((act!=null)&& (act.equalsIgnoreCase("causale")  || act.equalsIgnoreCase("refresh") ) )
  ...
  classFatts2=remote.getCausXContr(cod_tipo_contr,contrSelez,clasOggFattSelez,cod_PS,oggFattSelez);
  }
  ...
  OpzioniElem opzioni = remoteOpzioniTariffa.getOpzioniFlag(oggFattSelez,cod_PS);
      ...
      {
         classOpzioniTariffa = remoteOpzioniTariffa.getDispOpzXContr(contrSelez, oggFattSelez,cod_PS);
         flagExc="opzione";
      }
      else
      {
...
{
  String strResult="TariffaXContrCntl";
      strResult+="?act=insert";
      strResult+="&cod_contr="+contrSelez;
...
<%
  Collection oggfatt= homeOggFatt1.findOggFattAssPsXContr(cod_tipo_contr,contrSelez,cod_PS);
