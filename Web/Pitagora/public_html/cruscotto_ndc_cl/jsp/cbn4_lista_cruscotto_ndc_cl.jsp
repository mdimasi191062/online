...
<logtag:logData id="<%= ((clsInfoUser)session.getAttribute(StaticContext.ATTRIBUTE_USER)).getUserName() %>">
  <%=StaticMessages.getMessage(3006,"cbn4_lista_cruscotto_ndc_cl.jsp")%>
</logtag:logData>
<%
...
<%  
    ...
    collection = cruscottoNdc.findAll_cla(strDATA_INIZIO_CICLO_FATRZ, strDATA_FINE_CICLO_FATRZ, strTIPO_FLAG_FUNZIONE_CREAZ_IMPT, strRIFERITO_FATTURA, strCODE_GEST, strCODE_ACCOUNT);      
...
function submitFrmSearch(typeLoad)
{
 ...
 // document.frmSearch.submit();
  ...
  var asyncFunz= function(){ handler_generico2(http,carica,errore);};
  chiamaRichiesta2(document.frmSearch,asyncFunz);
}  


function openGestori(){
  openDialog("visualizza_gestori_cl.jsp", 500, 350); 
}
...
function exportCsv(){
  ...
  var sendMessage='codiceTipoContratto=1&codeFunz=30&id_funz=21&codeTipoContr=&codeGest='+codGest+'&codAccount='+codAccount+'&dataInizio='+dataInizio+'&dataFine='+dataFine+'&flagFunzione='+flagFunzione+'&rifFattura='+rifFattura;
...
<form name="frmSearch" onsubmit="submitFrmSearch('0');return false" method="post" action="cbn4_lista_cruscotto_ndc_cl.jsp">
