...
<%=StaticMessages.getMessage(3006,"download_cl.jsp")%>
</logtag:logData>
<%
String strMinCiclo = "";
String strMaxCiclo = "";
...
function ONESEGUI(){
  ...
  {  
    ...
    document.formPag.action="./download_file_cl.jsp";
...
function TipoEstrazione()
{
 ...
 var errore = function(dati){gestisciMessaggio(dati[0].messaggio);};
 var asyncFunz=  function(){ handler_generico(http,carica,errore);};
 chiamaRichiesta('funzioneCruscotto=21','EstrazioniConf',asyncFunz);
