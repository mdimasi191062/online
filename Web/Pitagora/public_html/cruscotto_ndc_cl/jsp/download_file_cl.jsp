...
<%=StaticMessages.getMessage(3006,"download_file_cl.jsp")%>
</logtag:logData>
...
System.out.println("download_file_cl.jsp - nomeFile ["+nomefile+"]");
String path             = request.getParameter("comboNomeFile");
System.out.println("download_file_cl.jsp - path     ["+path+"]");
