...
<%=StaticMessages.getMessage(3006,"visualizza_gestori_cl.jsp")%>
</logtag:logData>
...
<%
  ...
  {
    accountVector = gestore.findGest_cla(codeGest,codeAccount,descAccount);
...
function submitRicerca(typeLoad)
{
  ...
  objForm.action = "visualizza_gestori_cl.jsp";
  objForm.submit();
}
