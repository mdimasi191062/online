...
<%=StaticMessages.getMessage(3006,"visualizza_errore.jsp")%>
</logtag:logData>
<%
  String strindiceErrore=request.getParameter("indiceErrore");
  int i = Integer.parseInt(strindiceErrore);
  ...
  <TR>
    ...
    <TD>
      <TABLE border="0" cellPadding="0" cellSpacing="0" width="500" align="center">
        <TR>
          <TD vAlign="top" width="80"><IMG border="0"  src="../images/allineamentodb.gif" ></TD>
        <TR>
      </TABLE>
        ...
        <TR>
          <TD>
            <TABLE bgColor="#006699" border="0" cellPadding="0" cellSpacing="0" width="502">
              <TR>
                <TD bgColor="#006699" class="white" vAlign="top" width="88%">&nbsp; Visualizzazione Errore</TD>
        ...
        <TR>
          ...
          <TD>
            <TABLE bgColor="#006699" border="0" cellPadding="0" cellSpacing="0" width="100%">
              ...
              <TR>
                <td align='center' class='white'><% out.println(aRemote[i].getTEXT_MSG_ERR()); %></td>
                <TD>&nbsp;</TD>
              </TR>
