...
<%=StaticMessages.getMessage(3006,"cbn1_ver_ava_ric_cl.jsp")%>
</logtag:logData>
<% 
...
<TITLE>Verifica stato avanzamento costi</TITLE>
</HEAD>
...
<%
   collection = home.findAllSar(codiceTipoContratto);          
...
<form name="frmSearch" onsubmit="submitFrmSearch('0');return false" method="post" action="cbn1_ver_ava_ric_cl.jsp">
<table align=center width="90%" border="0" cellspacing="0" cellpadding="0">
  ...
  <!-- Gestione navigazione-->
<form name="frmDati" method="post" action='cbn1_ver_sar_lista_account_cl.jsp'>
        <tr>
          <td>
...
if (sMessaggio != null) { 
%>
   alert('Attenzione impossibile procedere con l'elaborazione');
<% 
}
if ((aRemote==null)||(aRemote.length==0)) { 
%>
