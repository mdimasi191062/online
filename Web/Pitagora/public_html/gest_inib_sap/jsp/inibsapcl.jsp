...
<%=StaticMessages.getMessage(3006,"inibsapcl.jsp")%>
</logtag:logData>
...
if (operazione.equals("1"))
{
    ...
    codicesap = inibSap.findGestore(rch_desc_gest,"C");
}
else
    if (operazione.equals("D"))
    {
        ...
        codicesap = inibSap.findAllGestore("C");
    }
    else
...
function click_cmdAccount(){
      ...
      URL='sel_account_Inib_SapCl.jsp' + URLParam;
...
{ 
    ...
    {
        document.formPag.action = "inibsapcl.jsp?operazione=2";
        document.formPag.submit();
    }
     else 
    {
        document.formPag.action = "inibsapcl.jsp?operazione=1";
        document.formPag.submit();
    }
}
...
{ 
    ...
    else
    {
        ...
        {
            document.formPag.action = "inibsapcl.jsp?operazione=M";
            document.formPag.submit();
        }
    }
}
...
{ 
    ...
    {
        document.formPag.action = "inibsapcl.jsp?operazione=D";
        document.formPag.submit();
    }
...
{ 
    ...
    {
        document.formPag.action = "inibsapcl.jsp?operazione=C";
        document.formPag.submit();
    }
...
if ( document.formPag.txtDescAccount.value == '' ) {
    ...
    if (confirm("Procedere con l'inserimento della Regola?")==true)
    {
      ...
      openDialog("salva_inib_sapCl.jsp" + sParametri, 600, 320);   
    }
    document.formPag.action = "inibsapcl.jsp?operazione=2";
    document.formPag.submit();
}
...
<table align=center width="90%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><img src="../images/InibSapCl.gif" border="0"></td>
  </tr>
  <tr>
