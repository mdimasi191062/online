...
document.oggFattForm.causaleSelez.value=document.oggFattForm.comboCausale[document.oggFattForm.comboCausale.selectedIndex].value;
 ...
 else
 {
    ...
    //viti 27-02-03
    // Enable(document.oggFattForm.comboOpzioniTariffa);
    Disable(document.oggFattForm.comboOpzioniTariffa);
    document.oggFattForm.comboOpzioniTariffa[0].selected=true;    
...
alert(
           ...
           "\rCODE_TIPO_OPZIONE :"+document.oggFattForm.tipoOpzSelez.value); //viti 27-02-03
}
...
function selezionaPs()
{
  ...
  var chiamante="TariffaSp";
  var stringa="../../tariffe/jsp/ProdServSp.jsp?cod_tipo_contr="+cod_tipo_contr+"&des_tipo_contr="+des_tipo_contr+"&chiamante="+chiamante;
...
function ONCONFERMA()
{
   ...
   if (document.oggFattForm.cod_PS.value=="" || document.oggFattForm.cod_PS.value=="null")
      {
   ...
   else
       {
          if (confirm("Si conferma l'inserimento della tariffa?"))
          {
            ...
            var strURL="TariffaWfSp.jsp";
                ...
                //document.oggFattForm.comboOpzioniTariffa[document.oggFattForm.comboOpzioniTariffa.selectedIndex].value;
