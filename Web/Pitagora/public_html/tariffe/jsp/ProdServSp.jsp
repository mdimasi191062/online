...
if (chiamante!=null && chiamante.equalsIgnoreCase("TariffaSp")) 
...
if ((act!=null)&&(act.equalsIgnoreCase("verTarAcq")))
  {%>
  <EJB:useHome id="homeNumTar" type="com.ejbBMP.TariffaBMPHome" location="TariffaBMP" />
<%
     remoteNumTar= homeNumTar.findNumTar(cod_tipo_contr,cod_ps);
...
function ONSELEZIONA()
{
      if (codPs!="")
      {
        if(document.frmSearch.chiamante.value=="TariffaSp")
        {
          document.frmSearch.cod_PS.value=codPs;
          document.frmSearch.des_PS.value=descPs;
          document.frmSearch.act.value="verTarAcq";
          document.frmSearch.action="ProdServSp.jsp";
          document.frmSearch.submit();
        }
//nd inizio aggiornamento 13/09/02 inizio
         else if(document.frmSearch.chiamante.value=="InsAssOfPsSp")
        {
...
//nd fine aggiornamento 13/09/02 
        else
        { 
          opener.document.oggFattForm.des_PS.value=descPs;
          opener.document.oggFattForm.cod_PS.value=codPs;
          self.close();
          opener.dialogWin.returnFunc();
        }
   }
...
{
  <%
   Collection oggfatt= homeOggFatt.findOggFattAssPs(cod_ps,cod_tipo_contr);
...
else
{
   ...
   {
      if (chiamante.equalsIgnoreCase("ListaTariffeSp")) 
      {
         prodServ = remoteProdServ.getPs(cod_tipo_contr,strPsRicerca);
      }
       else
       if (chiamante.equalsIgnoreCase("InsAssOfPsSp")) 
      {
         prodServ = remoteProdServ.getPsAssOfPs(cod_tipo_contr,strPsRicerca);
      }
      else
        {
          prodServ = remoteProdServ.getPsTar(cod_tipo_contr,strPsRicerca);
        }
...
<form name="frmSearch" method="get" action="ProdServSp.jsp">
...
<table align=center width="90%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
				<tr>
					<td>
					  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
              <tr>
                <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Lista di selezione dei Prodotti/Servizi</td>
  ...
  <tr>
    <td bgcolor="<%=StaticContext.bgColorCellaBianca%>"><img src="../../common/images/pixel.gif" width="1" height='3'></td>
  </tr>
  <tr>
    <td>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorTabellaForm%>">
                    <tr>
                      <td colspan='4' bgcolor="<%=StaticContext.bgColorCellaBianca%>"><img src="../../common/images/pixel.gif" width="1" height='2'></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="textB" >&nbsp;</td>
                      <td class="textB" >&nbsp;</td>
                      <!--td class="textB" width="25%">&nbsp;</td>
                      <td class="text" width="25%" align="left">&nbsp;</td-->
                    </tr>
 <tr>
               ...
               <%
                ...
                %>
                       <tr>                                                                                                      
                        ...
                        <input bgcolor='<%=StaticContext.bgColorCellaBianca%>'  type='radio' name="SelOf" id="<%=obj.getDescPs()%>" value="<%=obj.getCodePs()%>" <%if (first_rec) {out.print("checked");first_rec=false;}%> onclick="ChangeSel('<%=obj.getCodePs()%>','<%=obj.getDescPs().replace('\'','Æ')%>')"-->
                       <%
                         if (caricaDesc)
                         {
                          caricaDesc=false;%>
                ...
                <tr>
                  <td colspan='5' bgcolor="<%=StaticContext.bgColorCellaBianca%>"><img src="../../common/images/pixel.gif" width="1" height='2'></td>
                </tr>
