...
<%=StaticMessages.getMessage(3006,"cbn1_ins_tar_x_tipol_contr_cvp_cl.jsp")%>
</logtag:logData>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function ONCONTINUA()
	{
		...
		{
			case "UPD":
				objForm.action="<%=StaticContext.PH_TARIFFE_JSP%>cbn1_ins_tar_x_tipol_contr_cvp_2_cl.jsp";
				break;
			case "INS":
				objForm.action="<%=StaticContext.PH_TARIFFE_JSP%>cbn1_ins_tar_x_tipol_contr_cvp_2_cl.jsp";
				break;
    ...
    */
    ...
    openDialog("<%=StaticContext.PH_TARIFFE_JSP%>cbn1_ins_tar_x_tipol_contr_cvp_2_cl.jsp?hidViewState=" + objForm.hidViewState.value,800,600,"");
		/*
...
<form name="frmDati" method="post" action="">
	...
	<!--TITOLO PAGINA-->
<table width="90%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorCellaBianca%>" align = "center">
  <tr>
	...
	<tr>
		<td>
		 <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
			<tr>
			  <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%"><%=lstrTitoloPagina%> Tariffa per tipologia di contratto: <%=request.getParameter("hidDescTipoContratto")%></td>
...
<tr>
    ...
    <td height="30" width="85%" colspan="3">
		<input class="text" title="P/S"  type="text" size="50" maxlength="100" name="txtPs" value="">
...
<tr>
    ...
    <td height="30" width="85%" colspan="3">
		<input class="text" title="P/S"  type="text" size="50" maxlength="100" name="txtPsCompFatt" value="">
...
<tr>
	...
	<td class="text" height="30" width="35%">
