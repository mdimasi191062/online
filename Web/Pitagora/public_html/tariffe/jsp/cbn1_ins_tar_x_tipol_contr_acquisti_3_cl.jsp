...
<%=StaticMessages.getMessage(3006,"cbn1_ins_tar_x_tipol_contr_acquisti_3_cl.jsp")%>
</logtag:logData>
...
String strDESCTIPOLOGIACONTRATTO = "ACQUISTI";
%>
<%!
	...
	<html>
		<head>
			...
			<script>
				...
				function ONCONTINUA(){
					strURL = "cbn1_ins_tar_x_tipol_contr_acquisti_3_cl.jsp";
