...
<%=StaticMessages.getMessage(3006,"cbn1_ins_tar_x_tipol_contr_acquisti_cl.jsp")%>
</logtag:logData>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function ONCONTINUA(){
		if(validazioneCampi(objForm)){
			objForm.action="<%=StaticContext.PH_TARIFFE_JSP%>cbn1_ins_tar_x_tipol_contr_acquisti_2_cl.jsp";
      ...
      var lstr_url = "<%=StaticContext.PH_TARIFFE_JSP%>cbn1_ins_tar_x_tipol_contr_acquisti_2_cl.jsp";
      lstr_url += "?hidViewState=" + objForm.hidViewState.value;
      lstr_url += "&intAction=<%=intAction%>";
      lstr_url += "&intFunzionalita=<%=intFunzionalita%>";
      
      openDialog(lstr_url, 800, 600, null);
			// objForm.submit();
