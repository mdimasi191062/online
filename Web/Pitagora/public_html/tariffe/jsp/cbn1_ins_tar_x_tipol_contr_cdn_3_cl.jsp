...
<%=StaticMessages.getMessage(3006,"cbn1_ins_tar_x_tipol_contr_cdn_3_cl.jsp")%>
</logtag:logData>
...
<%
    ...
    String strDESCTIPOLOGIACONTRATTO = "CDN";
%>
<%!
...
private void inizializeTariffeVector(HttpSession psession, 
    ...
    for(j=1;(strAppo = request.getParameter("txtContributi"+j))!=null;j++){
        strImportoContributi = request.getParameter("txtContributi"+j);
        strImportoAccesso = request.getParameter("txtAccesso"+j);
        strImporto0_60KM = request.getParameter("txt0_60KM"+j);
        strImporto61_300KM = request.getParameter("txt61_300KM"+j);
        strImportoOltre300KM = request.getParameter("txtOltre300KM"+j);
...
private DB_Tariffe inizializeTariffaObject(String p_strImporto,String p_strTipoImporto,int p_intNumRow,String p_strCodePrFascia,String p_strCodeFascia) throws Exception{
    ...
    if(blnMascheraClassi){ // ho le classi di sconto associate
        ...
        strCodeClassSconto = "5"; // lp 25052004
...
<%
    ...
    inizializeTariffeVector(session,request);
    ...
    strUrl += "?message=" + java.net.URLEncoder.encode(strMsgOutput,com.utl.StaticContext.ENCCharset); 
    strUrl += "&CHIUDI=true";
	...
	<html>
		<head>
			...
			<script>
				...
				function ONCONTINUA(){
					strURL = "cbn1_ins_tar_x_tipol_contr_cdn_3_cl.jsp";
