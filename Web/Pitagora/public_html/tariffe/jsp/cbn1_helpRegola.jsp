...
<%
  int CodeRegola = Integer.parseInt(request.getParameter("CodeRegola"));
  DB_RegolaTariffa objRegolaTariffa = remoteEnt_RegoleTariffe.getDescRegolaTariffa(CodeRegola);
%>
<html>
<head>
    ...
    <TABLE width="100%" height="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
          ...
          <TABLE width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
            <TR align="middle">
              <TD bgcolor="<%=StaticContext.bgColorHeader%>" class="white">
                <%=objRegolaTariffa.getDESC_REGOLA()%>
              </TD>
      ...
      <TR bgcolor="<%=StaticContext.bgColorCellaBianca%>">
        <TD align="center" valign="middle" width="100%" height="100%">
            <textarea class="text" style="width:100%;height:100%"><%=objRegolaTariffa.getDESC_ESTESA_REGOLA()%>
            </textarea>
        </TD>
      </TR>
