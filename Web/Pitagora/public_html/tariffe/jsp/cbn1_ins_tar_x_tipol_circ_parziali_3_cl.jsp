...
<%=StaticMessages.getMessage(3006,"cbn1_ins_tar_x_tipol_circ_parziali_3_cl.jsp")%>
</logtag:logData>
...
String strDESCTIPOLOGIACONTRATTO = "CIRCUITI PARZIALI";
...
String strContributo = "";
//String strCanonePorta = "";
String strAccessoCanone = "";
...
private void inizializeTariffeVector(HttpSession psession, 
	...
	strContributo = Misc.getParameterValue(strViewState,"vsContributo");
	//strCanonePorta = Misc.getParameterValue(strViewState,"vsCanonePorta");
	strAccessoCanone = Misc.getParameterValue(strViewState,"vsAccessoCanone");
	...
	if(!strImportiFasceKm.equals("$$$")){ //Importi fasce
		...
		for (j=0;j < vctImportiFasceKm.size();j++)
		{
            ...
            if(!strAppoImporto.equals("")){
				
				l_objTariffa = (DB_Tariffe)inizializeTariffaObject(strAppoImporto,Integer.toString(++intContatore));
            	lvct_Tariffe.addElement(l_objTariffa);
			}
		}
	}

	if(!strContributo.equals("")){
		strAppoImporto = strContributo;
        strCodeFascia = "";
	...
	if(!strAccessoCanone.equals("")){
		strAppoImporto = strAccessoCanone;
        strCodeFascia = "";
		l_objTariffa = (DB_Tariffe)inizializeTariffaObject(strAppoImporto,"");
        lvct_Tariffe.addElement(l_objTariffa);
	}
	...
	<html>
		<head>
			...
			<script>
				...
				function ONCONTINUA(){
					strURL = "cbn1_ins_tar_x_tipol_circ_parziali_3_cl.jsp";
