...
<%=StaticMessages.getMessage(3006,"cbn1_ins_tar_x_tipol_circ_parziali_cl.jsp.jsp")%>
</logtag:logData>
...
<SCRIPT LANGUAGE="JavaScript">
    ...
    switch(lstrPageAction)
		{
			case "UPD":
				objForm.action="<%=StaticContext.PH_TARIFFE_JSP%>cbn1_ins_tar_x_tipol_circ_parziali_2_cl.jsp";
				break;
			case "INS":
				objForm.action="<%=StaticContext.PH_TARIFFE_JSP%>cbn1_ins_tar_x_tipol_circ_parziali_2_cl.jsp";
				break;
...
*/
    ...
    openDialog("<%=StaticContext.PH_TARIFFE_JSP%>cbn1_ins_tar_x_tipol_circ_parziali_2_cl.jsp?hidViewState="+ objForm.hidViewState.value,800,600,"");
