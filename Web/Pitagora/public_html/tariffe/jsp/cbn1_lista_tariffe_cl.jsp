...
<%=StaticMessages.getMessage(3006,"cbn1_lista_tariffe_cl.jsp")%>
</logtag:logData>
...
function ONCONTINUA()
{
  ...
  else
  {
    ...
    <%if(intAction==StaticContext.LIST){//Lista%>
        strURL += "<%=StaticContext.PH_TARIFFE_JSP%>cbn1_lista_tariffe_2_cl.jsp";
    <%}else{//INSERT%>
        strURL += "<%=StaticContext.PH_TARIFFE_JSP%>cbn1_inserimento_tariffe_2_cl.jsp";
    <%}%>
