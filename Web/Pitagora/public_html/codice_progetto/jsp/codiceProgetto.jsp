                ...
                <tr>
                  <td>
                    <table width="100%" border="0" cellspacing="10" cellpadding="0" bgcolor="<%=StaticContext.bgColorTabellaForm%>" >
                        <tr>
                          <td width="49%" class="textB" align="left">&nbsp; Servizio Logico</td>
                         ...
                         <tr>
                          <td width="49%" class="textB" align="left">&nbsp; Tipologia </td>
                          <td class="text" align="left" width="100%" colspan="2">
                            <div name="divTipologia" id="divTipologia"/>
                          </td>
                        </tr>
                         <tr>
                          <td width="49%" class="textB" align="left">&nbsp; Codice Progetto </td>
                          <td class="text" align="left" width="100%" colspan="2">
                            <div name="divCodiceProgetto" id="divCodiceProgetto"/>
                            <input type="text" class="text" id="divCodiceProgetto" name="divCodiceProgetto" />
                          </td>
                        </tr>
                        <tr>
                          <td width="49%" class="textB" align="left">&nbsp; Data Contrattualizzata </td>
                          <td class="text" align="left" width="100%" colspan="2">
                            <div name="divDataDiRiferimento" id="divDataDiRiferimento"/>
                          </td>
                        </tr>
