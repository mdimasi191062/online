...
<%=StaticMessages.getMessage(3006,"VerificaReportSp.jsp")%>
</logtag:logData>
...
{
    document.verificaForm.action="ReportLstAccElabSp.jsp" ;
    document.verificaForm.submit();
}
...
function setTipoReportStart(){
  if(document.verificaForm.tipoReport.value == '499'){
    ...
    document.verificaForm.tipoReport.value = "499";
  }else if (document.verificaForm.tipoReport.value =='498'){
    document.verificaForm.txtRadio0.checked = false;
    document.verificaForm.txtRadio1.checked = true;
    document.verificaForm.txtRadio2.checked = false;
    document.verificaForm.tipoReport.value = "498";
  } else
  {
    document.verificaForm.txtRadio0.checked = false;
    document.verificaForm.txtRadio1.checked = false;
    document.verificaForm.txtRadio2.checked = true;
    document.verificaForm.tipoReport.value = "497";
  }
}
...
<form name="verificaForm" method="get" action="VerificaReportSp.jsp">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
				<tr>
					<td>
					  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
              <tr>
                <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Verifica Report</td>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorRigaDispariTabella%>">
                    ...
                    <tr>
                      <td width="50%" class="textB" align="left">&nbsp; Verifica Batch Report : &nbsp;</td>
                    </tr>
                    <tr>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorRigaDispariTabella%>">
                    <tr>
                      <td class="textB" align="left">
                        <table>
                          <tr>
                            <td class="textB" align="left">&nbsp;Report Valorizzazione:</td>
                            <td  width="10%" class="text" align="left">
                              <input type='radio' name='txtRadio0' value='499' onclick='setTipoReport(this.value);'>
                            </td>
                            <td class="textB" align="left">Report Repricing:</td>
                            <td  width="10%" class="text" align="left">
                              <input type='radio' name='txtRadio1' value='498' onclick='setTipoReport(this.value);'>
                            </td>
                             <td class="textB" align="left">Report Fatt./N.C. Manuale:</td>
                            <td  width="10%" class="text" align="left">
                              <input type='radio' name='txtRadio2' value='497' onclick='setTipoReport(this.value);'>
                            </td>
