...
<%=StaticMessages.getMessage(3006,"ReportLstAccElabSp.jsp")%>
</logtag:logData>
...
<form name="accElabForm" method="post" action="ReportLstAccElabSp.jsp">
<%
  ...
  {
    accElab = remoteLstAccElab.getLstAccReport(code_elab);
  }
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
				<tr>
					<td>
					  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
              <tr>
                <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Verifica Report: <%=desc_contratto%></td>
...
%>
              <tr>
               ...
               <td bgcolor='<%=StaticContext.bgColorFooter%>' class='textB'>Processo</td>
...
%>
                ...
                %>
                  <tr>
                    ...
                    <td bgcolor='<%=bgcolor%>' class='text'><%=obj.getCodeParam()%></td>
