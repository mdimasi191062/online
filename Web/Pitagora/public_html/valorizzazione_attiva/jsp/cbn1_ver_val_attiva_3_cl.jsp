...
<%=StaticMessages.getMessage(3006,"cbn1_ver_val_attiva_3_cl.jsp")%>
</logtag:logData>
...
<HEAD>
	...
	<script language="JavaScript">
		...
		function ONANNULLA(){
			...
			objForm.submit();
			//window.location="<%=StaticContext.PH_COMMON_JSP%>com_tc.jsp?strTitolo=Verifica%20Batch%20Valorizzazione%20Attiva&destinationPageClassic=/valorizzazione_attiva/jsp/cbn1_ver_val_attiva_cl.jsp&intAction=1&intFunzionalita=5";
		}
...
<form name="frmDati" action="cbn1_ver_val_attiva_3_cl.jsp">
			...
			<table width="50%" align='center' border="0" cellspacing="0" cellpadding="0">
				<tr>
                     <td class="textB" align="left" bgcolor="<%=StaticContext.bgColorTestataTabella%>">
					 	Risultati per pag.:&nbsp;
						<select class="text" name="cboNumRecXPag" onchange="reloadPage('1','cbn1_ver_val_attiva_3_cl.jsp');">
	...
	if(strPageAction.equals("CONGELA"))
	{
		//estrazione del code utente loggato dalla sessione
		  ...
		  <%
			...
			strResult = remoteCtr_ValAttiva.congela(lstr_CodeTipoContratto,
														   strCodeUtente,
