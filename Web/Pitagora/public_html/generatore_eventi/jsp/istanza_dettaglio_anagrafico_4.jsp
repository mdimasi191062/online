...
<%=StaticMessages.getMessage(3006,"istanza_dettaglio_anagrafico_4.jsp")%>
</logtag:logData>
...
<%
  ...
  strtypeLoad = Misc.nh(request.getParameter("hidTypeLoadATM"));
  if ( strtypeLoad.equals("") )
      strtypeLoad = (String)session.getAttribute("hidTypeLoadATM");
...
//GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  {
    vct_InventariAnag =  remoteEnt_Inventari.getInventarioAnagraficoATM(Code_Ist_Prod);
           /*MoS */
    ctrlvct_InventariAnag =  remoteEnt_Inventari.getInventarioAnagraficoATM(Code_Ist_Prod);
...
//FINE GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  DB_Invent_ATM data_InventariAnag = null;
  DB_Invent_ATM ctrldata_InventariAnag = null; 
  ...
  if ( ( typeLoad == 0 )|| ( typeLoad == 1 ) ) {
    ...
    data_InventariAnag = (DB_Invent_ATM)vct_InventariAnag.get(elementoSelezionato);
...
<title>
Inventario Anagrafico ( Servizio Trasporto-Dati )
</title>
...
<SCRIPT LANGUAGE="JavaScript" type="text/javascript">
  ...
  function ONSALVA(pagina) {
    ...
    ONRETTIFICA_SALVA();
    if (Errore == 0) {
      objForm.hidTypeLoadATM.value = '2';
  ...
  function ONANNULLAMODIFICHE() {
      frmDati.hidTypeLoadATM.value = '0';
      frmDati.submit();
  }  
  ...
  function visualizzaAnagrafica( obj ) {
      ...
      frmDati.srcDescTipoTerminaz.value           = getVS ( obj , "vsDESC_TIPO_TERMINAZIONE" );
      frmDati.srcDescFrazionamento.value          = getVS ( obj , "vsDESC_FRAZIONAMENTO" );
      ...
      frmDati.strTDKIT.value                      = getVS ( obj , "vsTD_KIT" );
  ...
  function caricaDati(){
      ...
      frmDati.srcDescTipoTerminaz.value           = '<%=data_InventariAnag.getDESC_TIPO_TERMINAZIONE()%>';
      frmDati.srcDescFrazionamento.value          = '<%=data_InventariAnag.getDESC_FRAZIONAMENTO()%>';
      ...
      frmDati.strTDKIT.value                      = '<%=data_InventariAnag.getTD_KIT()%>';
   ...
   function ONRETTIFICA() {
      ...
      Enable ( frmDati.srcDescTipoTerminaz);
      Enable ( frmDati.srcDescFrazionamento);
      Enable ( frmDati.srcDescTipoReteSede1);
      Enable ( frmDati.srcDescTipoReteSede2);
      Enable ( frmDati.strTDKIT);
  ...
  function DisabilitaAnagrafica () {
      ...
      Disable ( frmDati.srcDescTipoTerminaz);
      Disable ( frmDati.srcDescFrazionamento);
      Disable ( frmDati.srcDescTipoReteSede1);
      Disable ( frmDati.srcDescTipoReteSede2);
      Disable ( frmDati.strTDKIT);
...
<body onLoad="Initialize();resizeTo(screen.width,screen.height)" onfocus=" ControllaFinestra()" onmouseover=" ControllaFinestra()"  >
    ...
    <input type="hidden" name="hidTypeLoadATM" value="">
    ...
    <input type="hidden" name="paginaSorgente" value="istanza_dettaglio_anagrafico_4.jsp?Istanza=<%=Code_Ist_Prod%>">    
...
<!-- INIZIO Visualizzazione Prodotto -->
                  ...
                  String strCodeIstanzaProd = null;
                    ...
                    for (int i = 0;i < vct_InventariAnag.size();i++){
                      ...
                      data_InventariAnag = (DB_Invent_ATM)vct_InventariAnag.get(i);
                      strCodeIstanzaProd = data_InventariAnag.getPROD();
                                                  /*MoS*/
                   //================================================================
                   if ( ctrlvct_InventariAnag != null){
                           ctrldata_InventariAnag = null;
                       ctrldata_InventariAnag = (DB_Invent_ATM)ctrlvct_InventariAnag.get(i) ;
                   ...
                   //================================================================
                    ...
                    <% if ( data_InventariAnag.getTAB().equals("P") ) { %>
                      ...
                      <% /* Memorizzazione delle anagrafiche */
                           ...
                           strViewStateCostructor += "vsTD_KIT="                         + data_InventariAnag.getTD_KIT()                         + "|" ;
                           strViewStateCostructor += "vsIndice="                         + i                                                      + "|" ;
                           strViewStateCostructor += "vsGetTab="                         + data_InventariAnag.getTAB()                            + "|" ;
                      %>
                          <TD class="text" style="CURSOR: hand" id="<%=i%>" name="<%=i%>" onclick="ONSALVA('istanza_dettaglio_anagrafico_4.jsp?SELECTED=<%=i%>&Istanza=<%=Code_Ist_Prod%>&Servizio=<%=Code_Servizio%>')">
...
<!-- FINE Visualizzazione Prestazioni Aggiuntive -->  
      ...
      <tr>
         <TD colspan="4" bgcolor="<%=StaticContext.bgColorCellaBianca%>" class="textB" align="center" width="682">
                ...
                <U>TD Kit : </U>
                <input class="text" title="strTDKIT" name="strTDKIT" size="20">
          </TD>
      </tr>
        <tr>
        ...
        <tr>
            <TD class="text"> Descrizione Tipo Terminazione:  </TD>
             <TD>
              <INPUT class="text" id="srcDescTipoTerminaz" name="srcDescTipoTerminaz" obbligatorio="si" tipocontrollo="intero" label="Descrizione Tipo Terminazione" Update="false" size="35" >
            </TD>
            <TD class="text"> Descrizione Frazionamento:   </TD>
             <TD>
              <INPUT class="text" id="srcDescFrazionamento" name="srcDescFrazionamento" obbligatorio="si" tipocontrollo="intero" label="Descrizione Frazionamento" Update="false" size="35" >
            </TD>
        </tr>
        <tr>
        ...
        <tr>
            <TD colspan="4" class="text"> Descrizione Sede 1:  
              <INPUT class="text" id="srcDescSede1" name="srcDescSede1" obbligatorio="si" tipocontrollo="intero" label="Descrizione Sede 1" Update="false" size="115" title="<%=data_InventariAnag.getDESC_SEDE_1()%>" onchange="segnalaPropaga();">
            </TD>
        </tr>
        <tr>
...
<%
 ...
 <%      
      ...
      data_InventariAnag.setTD_KIT                         ( Misc.nh(request.getParameter("strTDKIT")));
      data_InventariAnag.setDESC_TIPO_TERMINAZIONE         ( Misc.nh(request.getParameter("srcDescTipoTerminaz")));
      data_InventariAnag.setDESC_FRAZIONAMENTO             ( Misc.nh(request.getParameter("srcDescFrazionamento")));
