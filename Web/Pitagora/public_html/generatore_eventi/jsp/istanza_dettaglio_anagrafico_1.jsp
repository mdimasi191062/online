...
<%=StaticMessages.getMessage(3006,"istanza_dettaglio_anagrafico_1.jsp")%>
</logtag:logData>
...
<%
  ...
  strtypeLoad = Misc.nh(request.getParameter("hidTypeLoadPP"));
...
//GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  Vector ctrlvct_InventariAnag1 = null;
  if (strtypeLoad!=null)
  {
  ...
  if (typeLoad!=0) {
    ...
    ctrlvct_InventariAnag1 = (Vector) session.getAttribute("ctrlvct_InventariAnag1");
  }
  else
  {
    vct_InventariAnag =  remoteEnt_Inventari.getInventarioAnagraficoPP(Code_Ist_Prod);
       /*MoS */
    ctrlvct_InventariAnag1 =  remoteEnt_Inventari.getInventarioAnagraficoPP(Code_Ist_Prod);
    if (vct_InventariAnag!=null) {
      session.setAttribute("vct_InventariAnag", vct_InventariAnag);
      session.setAttribute("ctrlvct_InventariAnag1", ctrlvct_InventariAnag1);
      session.setAttribute("hidTypeLoadPP", "1");
    }
  }
//FINE GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  int elementoSelezionato;
  DB_Invent_PP data_InventariAnag = null;
  DB_Invent_PP ctrldata_InventariAnag = null; 
  ...
  if ( ( typeLoad == 0 )|| ( typeLoad == 1 ) ) {
    ...
    data_InventariAnag = (DB_Invent_PP)vct_InventariAnag.get(elementoSelezionato);
...
<title>
Inventario Anagrafico ( Servizio Punto-Punto )
</title>
...
<body onLoad="Initialize();resizeTo(screen.width,screen.height)" onfocus=" ControllaFinestra()" onmouseover=" ControllaFinestra()" >
    ...
    <input type="hidden" name="hidTypeLoadPP" value="">
    ...
    <input type="hidden" name="paginaSorgente" value="istanza_dettaglio_anagrafico_1.jsp?Istanza=<%=Code_Ist_Prod%>">
...
<!-- INIZIO Visualizzazione Prodotto -->
                  ...
                  String strCodeIstanzaProd = null;
                    ...
                    for (int i = 0;i < vct_InventariAnag.size();i++){
                      ...
                      data_InventariAnag = (DB_Invent_PP)vct_InventariAnag.get(i);
                      strCodeIstanzaProd = data_InventariAnag.getPROD();
                            /*MoS*/
                   //================================================================
                   if ( ctrlvct_InventariAnag1 != null){
                           ctrldata_InventariAnag = null;
                       ctrldata_InventariAnag = (DB_Invent_PP)ctrlvct_InventariAnag1.get(i) ;
                   ...
                   //================================================================
                    ...
                    <% if ( data_InventariAnag.getTAB().equals("P") ) { %>
                      ...
                      %>
                          <TD class="text" style="CURSOR: hand" id="<%=i%>" name="<%=i%>" onclick="ONSALVA('istanza_dettaglio_anagrafico_1.jsp?SELECTED=<%=i%>&Istanza=<%=Code_Ist_Prod%>&Servizio=<%=Code_Servizio%>')">
