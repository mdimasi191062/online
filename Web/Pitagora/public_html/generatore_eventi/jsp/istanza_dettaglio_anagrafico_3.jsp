...
<%=StaticMessages.getMessage(3006,"istanza_dettaglio_anagrafico_3.jsp")%>
</logtag:logData>
...
<%
  ...
  strtypeLoad = Misc.nh(request.getParameter("hidTypeLoadRPVD"));
  if ( strtypeLoad.equals("") )
      strtypeLoad = (String)session.getAttribute("hidTypeLoadRPVD");
...
//GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  {
    vct_InventariAnag =  remoteEnt_Inventari.getInventarioAnagraficoRPVD(Code_Ist_Prod);
           /*MoS */
    ctrlvct_InventariAnag =  remoteEnt_Inventari.getInventarioAnagraficoRPVD(Code_Ist_Prod);
...
//FINE GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  DB_Invent_RPVD data_InventariAnag = null;
  DB_Invent_RPVD ctrldata_InventariAnag = null; 
  ...
  if ( ( typeLoad == 0 )|| ( typeLoad == 1 ) ) {
    ...
    data_InventariAnag = (DB_Invent_RPVD)vct_InventariAnag.get(elementoSelezionato);
...
<title>
Inventario Anagrafico ( Servizio RPV-D )
</title>
...
<SCRIPT LANGUAGE="JavaScript" type="text/javascript">
  ...
  function ONSALVA(pagina) {
    ...
    ONRETTIFICA_SALVA();
    if (Errore == 0) {
      objForm.hidTypeLoadRPVD.value = '2';
  ...
  function ONANNULLAMODIFICHE() {
      frmDati.hidTypeLoadRPVD.value = '0';
      frmDati.submit();
  }  
  ...
  function visualizzaAnagrafica( obj ) {
      ...
      frmDati.srcDescFlussoTerminaz.value         = getVS ( obj , "vsDESC_FLUSSO_TERMINAZ" );
  ...
  function caricaDati(){
      ...
      frmDati.srcDescFlussoTerminaz.value         = '<%=data_InventariAnag.getDESC_FLUSSO_TERMINAZ()%>';
   ...
   function ONRETTIFICA() {
      ...
      Enable ( frmDati.srcDescFlussoTerminaz );
  ...
  function DisabilitaAnagrafica () {
      ...
      Disable ( frmDati.srcDescFlussoTerminaz );
...
var strAppoCodeIstanzaCompo= frmDati.strElemento.value;
      
 strAppoCodeIstanzaCompo= strAppoCodeIstanzaCompo.substring(strAppoCodeIstanzaCompo.length-2,strAppoCodeIstanzaCompo.length);
 
  if (frmDati.srcDescCentraleSede1.value != frmDati.srcDescCentraleSede1.title && (strAppoCodeIstanzaCompo=='01')) {
    if (window.confirm('La variazione della Desc. Sede Centrale e Desc. Sede 1 saranno propagate su tutte le anagrafiche collegate.'))
    {
       frmDati.hidTypeLoadDescSede.value=frmDati.srcDescCentraleSede1.value + '@'  +frmDati.srcDescSede1.value; 
...
<body onLoad="Initialize();resizeTo(screen.width,screen.height)" onfocus=" ControllaFinestra()" onmouseover=" ControllaFinestra()"  >
    <FORM name="frmDati" id="frmDati" action="" method="post" on>
    <input type="hidden" name="hidTypeLoadRPVD" value="">
    ...
    <input type="hidden" name="paginaSorgente" value="istanza_dettaglio_anagrafico_3.jsp?Istanza=<%=Code_Ist_Prod%>">    
...
<!-- INIZIO Visualizzazione Prodotto -->
                  ...
                  String strCodeIstanzaProd = null;
                    ...
                    for (int i = 0;i < vct_InventariAnag.size();i++){
                      ...
                      data_InventariAnag = (DB_Invent_RPVD)vct_InventariAnag.get(i);
                      strCodeIstanzaProd = data_InventariAnag.getPROD();
                   /*MoS*/
                   //================================================================
                   if ( ctrlvct_InventariAnag != null){
                           ctrldata_InventariAnag = null;
                       ctrldata_InventariAnag = (DB_Invent_RPVD)ctrlvct_InventariAnag.get(i) ;
                   ...
                   //================================================================
                    ...
                    <% if ( data_InventariAnag.getTAB().equals("P") ) { %>
                      ...
                      <% /* Memorizzazione delle anagrafiche */
                           ...
                           strViewStateCostructor += "vsDESC_FLUSSO_TERMINAZ="           + data_InventariAnag.getDESC_FLUSSO_TERMINAZ()           + "|" ;
                      ...
                      %>
                          <TD class="text" style="CURSOR: hand" id="<%=i%>" name="<%=i%>" onclick="ONSALVA('istanza_dettaglio_anagrafico_3.jsp?SELECTED=<%=i%>&Istanza=<%=Code_Ist_Prod%>&Servizio=<%=Code_Servizio%>')">
...
<!-- FINE Visualizzazione Prestazioni Aggiuntive -->  
      ...
      <tr>
         <TD colspan="4" bgcolor="<%=StaticContext.bgColorCellaBianca%>" class="textB" align="center" width="682">
                ...
                <input class="texSel" title="strElemento" name="strElemento" readonly size="20">
          </TD>
      </tr>
        <tr>
            <TD class="text"> Numero Ordine Cliente:  </TD>
             <TD>
              <INPUT class="text" id="srcDescNumOrdineCliente" name="srcDescNumOrdineCliente" obbligatorio="si" tipocontrollo="intero" label="Numero Ordine Cliente Attivazione" Update="false" size="40">
            </TD>
            <TD class="text"> Numero Ordine Cliente di Cessazione:   </TD>
             <TD>
              <INPUT class="text" id="srcDescNumOrdineClienteCessaz" name="srcDescNumOrdineClienteCessaz" obbligatorio="si" tipocontrollo="intero" label="Numero Ordine Cliente Cessazione" Update="false" size="40">
            </TD>
        </tr>
        <tr>
            <TD class="text"> Descrizione Flusso Terminazione:  </TD>
             <TD>
              <INPUT class="text" id="srcDescFlussoTerminaz" name="srcDescFlussoTerminaz" obbligatorio="si" tipocontrollo="intero" label="Descrizione Flusso Terminazione" Update="false" size="40">
            </TD>
...
<%
 ...
 <%      
      ...
      data_InventariAnag.setDESC_FLUSSO_TERMINAZ           ( Misc.nh(request.getParameter("srcDescFlussoTerminaz")));
