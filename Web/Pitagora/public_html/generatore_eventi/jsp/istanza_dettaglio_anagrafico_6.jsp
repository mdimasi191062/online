...
<%=StaticMessages.getMessage(3006,"istanza_dettaglio_anagrafico_6.jsp")%>
</logtag:logData>
...
<%
  ...
  strtypeLoad = Misc.nh(request.getParameter("hidTypeLoadITC_REV"));
  if ( strtypeLoad.equals("") )
      strtypeLoad = (String)session.getAttribute("hidTypeLoadITC_REV");
...
//GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  {
    vct_InventariAnag =  remoteEnt_Inventari.getInventarioAnagraficoITCREV(Code_Ist_Prod);
           /*MoS */
    ctrlvct_InventariAnag =  remoteEnt_Inventari.getInventarioAnagraficoITCREV(Code_Ist_Prod);
    if (vct_InventariAnag!=null) {
      ...
      session.setAttribute("hidTypeLoadITC_REV", "1");
    }
  }
//FINE GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  int elementoSelezionato;
  DB_Invent_ITC_REV data_InventariAnag = null;
  DB_Invent_ITC_REV ctrldata_InventariAnag = null; 
  ...
  if ( ( typeLoad == 0 )|| ( typeLoad == 1 ) ) {
    ...
    data_InventariAnag = (DB_Invent_ITC_REV)vct_InventariAnag.get(elementoSelezionato);
...
<title>
Inventario Anagrafico ( Servizio ITC REV )
</title>
...
<SCRIPT LANGUAGE="JavaScript" type="text/javascript">
  ...
  function ONSALVA(pagina) {
    ...
    ONRETTIFICA_SALVA();
    if (Errore == 0) {
      objForm.hidTypeLoadITC_REV.value = '2';
  ...
  function ONANNULLAMODIFICHE() {
      frmDati.hidTypeLoadITC_REV.value = '0';
      frmDati.submit();
  }  
...
<body onLoad="Initialize();resizeTo(screen.width,screen.height)" onfocus=" ControllaFinestra()" onmouseover=" ControllaFinestra()" >
    ...
    <input type="hidden" name="hidTypeLoadITC_REV" value="">
    ...
    <input type="hidden" name="paginaSorgente" value="istanza_dettaglio_anagrafico_6.jsp?Istanza=<%=Code_Ist_Prod%>">
...
<!-- INIZIO Visualizzazione Prodotto -->
                  ...
                  String strCodeIstanzaProd = null;
                    ...
                    for (int i = 0;i < vct_InventariAnag.size();i++){
                      ...
                      data_InventariAnag = (DB_Invent_ITC_REV)vct_InventariAnag.get(i);
                      strCodeIstanzaProd = data_InventariAnag.getPROD();
                                                  /*MoS*/
                   //================================================================
                   if ( ctrlvct_InventariAnag != null){
                           ctrldata_InventariAnag = null;
                       ctrldata_InventariAnag = (DB_Invent_ITC_REV)ctrlvct_InventariAnag.get(i) ;
                   ...
                   //================================================================
                    ...
                    <% if ( data_InventariAnag.getTAB().equals("P") ) { %>
                      ...
                      %>
                          <TD class="text" style="CURSOR: hand" id="<%=i%>" name="<%=i%>" onclick="ONSALVA('istanza_dettaglio_anagrafico_6.jsp?SELECTED=<%=i%>&Istanza=<%=Code_Ist_Prod%>&Servizio=<%=Code_Servizio%>')">
