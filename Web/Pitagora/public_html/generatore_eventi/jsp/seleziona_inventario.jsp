...
<logtag:logData id="<%= ((clsInfoUser)session.getAttribute(StaticContext.ATTRIBUTE_USER)).getUserName() %>">
  <%=StaticMessages.getMessage(3006,"seleziona_inventario.jsp")%>
</logtag:logData>
	...
	<tr>
		<td>
		 <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
			<tr>
			  <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">SELEZIONA INVENTARIO PER RETTIFICA</td>
...
<form name="frmSearch" onsubmit="submitFrmSearch('0');return false" method="post" action="seleziona_inventario.jsp?operazione=1">
...
<script language="JavaScript">
  if(document.frmSearch.messaggio.value != ""){
    ...
    if(document.frmSearch.operazione.value == 1 &&
       document.frmSearch.messaggio.value == ""){
