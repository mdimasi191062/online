...
<%=StaticMessages.getMessage(3006,"istanza_dettaglio_anagrafico_5.jsp")%>
</logtag:logData>
...
<%
  ...
  String Code_Causale = Misc.nh(request.getParameter("CodeCausastle"));
  ...
  strtypeLoad = Misc.nh(request.getParameter("hidTypeLoadITC"));
  if ( strtypeLoad.equals("") )
      strtypeLoad = (String)session.getAttribute("hidTypeLoadITC");
...
//GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  {
    vct_InventariAnag =  remoteEnt_Inventari.getInventarioAnagraficoITC(Code_Ist_Prod);
           /*MoS */
    ctrlvct_InventariAnag =  remoteEnt_Inventari.getInventarioAnagraficoITC(Code_Ist_Prod);
    if (vct_InventariAnag!=null) {
      ...
      session.setAttribute("hidTypeLoadITC", "1");
    }
  }
//FINE GESTIONE CARICAMENTO VETTORE@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  int elementoSelezionato;
  DB_Invent_ITC data_InventariAnag = null;
  DB_Invent_ITC ctrldata_InventariAnag = null; 
  ...
  if ( ( typeLoad == 0 )|| ( typeLoad == 1 ) ) {
    ...
    data_InventariAnag = (DB_Invent_ITC)vct_InventariAnag.get(elementoSelezionato);
...
<title>
Inventario Anagrafico ( Servizio ITC )
</title>
...
<SCRIPT LANGUAGE="JavaScript" type="text/javascript">
  ...
  function ONSALVA(pagina) {
    ...
    ONRETTIFICA_SALVA();
    if (Errore == 0) {
      objForm.hidTypeLoadITC.value = '2';
  ...
  function ONANNULLAMODIFICHE() {
      frmDati.hidTypeLoadITC.value = '0';
      frmDati.submit();
  }  
  ...
  function visualizzaAnagrafica( obj ) {
      ...
      frmDati.srcDescTipoImpiantoSede1.value      = getVS ( obj , "vsDESC_TIPO_IMPIANTO_SEDE_1" );
      ...
      frmDati.srcDescTipoImpiantoSede2.value      = getVS ( obj , "vsDESC_TIPO_IMPIANTO_SEDE_2" );
      ...
      frmDati.srcDescTipoReteSede1.value          = getVS ( obj , "vsDESC_TIPO_RETE_SEDE_1" );
      frmDati.srcDescTipoReteSede2.value          = getVS ( obj , "vsDESC_TIPO_RETE_SEDE_2" );
  ...
  function caricaDati(){
      ...
      frmDati.srcDescTipoImpiantoSede1.value      = '<%=data_InventariAnag.getDESC_TIPO_IMPIANTO_SEDE_1()%>';
      ...
      frmDati.srcDescTipoImpiantoSede2.value      = '<%=data_InventariAnag.getDESC_TIPO_IMPIANTO_SEDE_2()%>';
      ...
      frmDati.srcDescTipoReteSede1.value          = '<%=data_InventariAnag.getDESC_TIPO_RETE_SEDE_1()%>';
      frmDati.srcDescTipoReteSede2.value          = '<%=data_InventariAnag.getDESC_TIPO_RETE_SEDE_2()%>';
   ...
   function ONRETTIFICA() {
      ...
      Enable ( frmDati.srcDescTipoImpiantoSede1 );
      Enable ( frmDati.srcDescTipoImpiantoSede2 );
      ...
      Enable ( frmDati.srcDescTipoReteSede1);
      Enable ( frmDati.srcDescTipoReteSede2);
  ...
  function DisabilitaAnagrafica () {
      ...
      Disable ( frmDati.srcDescTipoImpiantoSede1 );
      Disable ( frmDati.srcDescTipoImpiantoSede2 );
      ...
      Disable ( frmDati.srcDescTipoReteSede1);
      Disable ( frmDati.srcDescTipoReteSede2);
...
<body onLoad="Initialize();resizeTo(screen.width,screen.height)" onfocus=" ControllaFinestra()" onmouseover=" ControllaFinestra()" >
    ...
    <input type="hidden" name="hidTypeLoadITC" value="">
    ...
    <input type="hidden" name="paginaSorgente" value="istanza_dettaglio_anagrafico_5.jsp?Istanza=<%=Code_Ist_Prod%>">
...
<!-- INIZIO Visualizzazione Prodotto -->
                  ...
                  String strCodeIstanzaProd = null;
                    ...
                    for (int i = 0;i < vct_InventariAnag.size();i++){
                      ...
                      data_InventariAnag = (DB_Invent_ITC)vct_InventariAnag.get(i);
                      strCodeIstanzaProd = data_InventariAnag.getPROD();
                                                  /*MoS*/
                   //================================================================
                   if ( ctrlvct_InventariAnag != null){
                           ctrldata_InventariAnag = null;
                       ctrldata_InventariAnag = (DB_Invent_ITC)ctrlvct_InventariAnag.get(i) ;
                   ...
                   //================================================================
                    ...
                    <% if ( data_InventariAnag.getTAB().equals("P") ) { %>
                      ...
                      <% /* Memorizzazione delle anagrafiche */
                           ...
                           strViewStateCostructor += "vsDESC_TIPO_IMPIANTO_SEDE_1="      + data_InventariAnag.getDESC_TIPO_IMPIANTO_SEDE_1()      + "|" ;                           
                           ...
                           strViewStateCostructor += "vsDESC_TIPO_IMPIANTO_SEDE_2="      + data_InventariAnag.getDESC_TIPO_IMPIANTO_SEDE_2()      + "|" ;                                                      
                           ...
                           strViewStateCostructor += "vsDESC_TIPO_TERMINAZIONE="         + data_InventariAnag.getDESC_TIPO_TERMINAZIONE()         + "|" ;
                           strViewStateCostructor += "vsDESC_FRAZIONAMENTO="             + data_InventariAnag.getDESC_FRAZIONAMENTO()             + "|" ;
                           strViewStateCostructor += "vsDESC_TIPO_RETE_SEDE_1="          + data_InventariAnag.getDESC_TIPO_RETE_SEDE_1()          + "|" ;
                           strViewStateCostructor += "vsDESC_TIPO_RETE_SEDE_2="          + data_InventariAnag.getDESC_TIPO_RETE_SEDE_2()          + "|" ;
                           strViewStateCostructor += "vsIndice="                         + i                                                      + "|" ;                           
                           strViewStateCostructor += "vsGetTab="                         + data_InventariAnag.getTAB()                            + "|" ;                           

                      %>
                          <TD class="text" style="CURSOR: hand" id="<%=i%>" name="<%=i%>" onclick="ONSALVA('istanza_dettaglio_anagrafico_5.jsp?SELECTED=<%=i%>&Istanza=<%=Code_Ist_Prod%>&Servizio=<%=Code_Servizio%>')">
      ...
      <tr>
        ...
        <tr>
            <TD class="text"> Numero Ordine Cliente:  </TD>
             <TD>
              <INPUT class="text" id="srcDescNumOrdineCliente" name="srcDescNumOrdineCliente" obbligatorio="si" tipocontrollo="intero" label="Numero Ordine Cliente Attivazione" Update="false" size="35">
            </TD>
            <TD class="text"> Numero Ordine Cliente di Cessazione:   </TD>
             <TD>
              <INPUT class="text" id="srcDescNumOrdineClienteCessaz" name="srcDescNumOrdineClienteCessaz" obbligatorio="si" tipocontrollo="intero" label="Numero Ordine Cliente Cessazione" Update="false" size="35">
            </TD>
        </tr>
        <tr>
            <TD class="text"> Descrizione Tipo Rete Sede 1:  </TD>
             <TD>
              <INPUT class="text" id="srcDescTipoReteSede1" name="srcDescTipoReteSede1" obbligatorio="si" tipocontrollo="intero" label="Descrizione Tipo Rete Sede 1" Update="false" size="35" >
            </TD>
            <TD class="text"> Descrizione Tipo Rete Sede 2:   </TD>
             <TD>
              <INPUT class="text" id="srcDescTipoReteSede2" name="srcDescTipoReteSede2" obbligatorio="si" tipocontrollo="intero" label="Descrizione Tipo Rete Sede 2" Update="false" size="35" >
            </TD>
        </tr>
        <tr>
            <TD colspan="4" class="text"> Descrizione Sede 1:  
              <INPUT class="text" id="srcDescSede1" name="srcDescSede1" obbligatorio="si" tipocontrollo="intero" label="Descrizione Sede 1" Update="false" size="115" >
            </TD>
        </tr>
        <tr>
            <TD colspan="4" class="text"> Descrizione Sede 2:   
              <INPUT class="text" id="srcDescSede2" name="srcDescSede2" obbligatorio="si" tipocontrollo="intero" label="Descrizione Sede 2" Update="false" size="115">
            </TD>
        </tr>
        <tr>
            <TD class="text"> Descrizione Tipo Impianto Sede 1:  </TD>
             <TD>
              <INPUT class="text" id="srcDescTipoImpiantoSede1" name="srcDescTipoImpiantoSede1" obbligatorio="si" tipocontrollo="intero" label="Descrizione Tipo Impianto Sede 1" Update="false" size="35">
            </TD>
            <TD class="text"> Descrizione Tipo Impianto Sede 2:   </TD>
             <TD>
              <INPUT class="text" id="srcDescTipoImpiantoSede2" name="srcDescTipoImpiantoSede2" obbligatorio="si" tipocontrollo="intero" label="Descrizione Tipo Impianto Sede 2" Update="false" size="35">
            </TD>
        </tr>
        ...
        <tr>
            <TD class="text"> Descrizione Impianto Sede 1:  </TD>
             <TD>
              <INPUT class="text" id="srcDescImpiantoSede1" name="srcDescImpiantoSede1" obbligatorio="si" tipocontrollo="intero" label="Descrizione Impianto Sede 1" Update="false" size="35">
            </TD>
            <TD class="text"> Descrizione Impianto Sede 2:   </TD>
             <TD>
              <INPUT class="text" id="srcDescImpiantoSede2" name="srcDescImpiantoSede2" obbligatorio="si" tipocontrollo="intero" label="Descrizione Impianto Sede 2" Update="false" size="35">
            </TD>
        </tr>
        <tr>
            <TD class="text"> Descrizione Comune Sede 1:  </TD>
             <TD>
              <INPUT class="text" id="srcDescComuneSede1" name="srcDescComuneSede1" obbligatorio="si" tipocontrollo="intero" label="Descrizione Comune Sede 1" Update="false" size="35">
            </TD>
            <TD class="text"> Descrizione Comune Sede 2:   </TD>
             <TD>
              <INPUT class="text" id="srcDescComuneSede2" name="srcDescComuneSede2" obbligatorio="si" tipocontrollo="intero" label="Descrizione Comune Sede 2" Update="false" size="35">
            </TD>
        </tr>
        <tr>
            <TD class="text"> Descrizione Provincia Sede 1:  </TD>
             <TD>
              <INPUT class="text" id="srcDescProvinciaSede1" name="srcDescProvinciaSede1" obbligatorio="si" tipocontrollo="intero" label="Descrizione Provincia Sede 1" Update="false" size="35">
            </TD>
            <TD class="text"> Descrizione Provincia Sede 2:   </TD>
             <TD>
              <INPUT class="text" id="srcDescProvinciaSede2" name="srcDescProvinciaSede2" obbligatorio="si" tipocontrollo="intero" label="Descrizione Provincia Sede 2" Update="false" size="35">
            </TD>
        </tr>
        <tr>
            <TD class="text"> Descrizione Dtrt Sede 1:  </TD>
             <TD>
              <INPUT class="text" id="srcDescDtrtSede1" name="srcDescDtrtSede1" obbligatorio="si" tipocontrollo="intero" label="Descrizione Dtrt Sede 1" Update="false" size="35">
            </TD>
            <TD class="text"> Descrizione Dtrt Sede 2:   </TD>
             <TD>
              <INPUT class="text" id="srcDescDtrtSede2" name="srcDescDtrtSede2" obbligatorio="si" tipocontrollo="intero" label="Descrizione Dtrt Sede 2" Update="false" size="35">
            </TD>
        </tr>
        <tr>
            <TD class="text"> Descrizione Centrale Sede 1:  </TD>
             <TD>
              <INPUT class="text" id="srcDescCentraleSede1" name="srcDescCentraleSede1" obbligatorio="si" tipocontrollo="intero" label="Descrizione Centrale Sede 1" Update="false" size="35" title="<%=data_InventariAnag.getDESC_CENTRALE_SEDE_1()%>" onchange="segnalaPropaga();">
            </TD>
            <TD class="text"> Descrizione Centrale Sede 2:   </TD>
             <TD>
              <INPUT class="text" id="srcDescCentraleSede2" name="srcDescCentraleSede2" obbligatorio="si" tipocontrollo="intero" label="Descrizione Centrale Sede 2" Update="false" size="35">
            </TD>
        </tr>
     </table>
            </TD>
...
<%
 ...
 <%  
      ...
      data_InventariAnag.setDESC_TIPO_RETE_SEDE_1          ( Misc.nh(request.getParameter("srcDescTipoReteSede1")));
      data_InventariAnag.setDESC_TIPO_IMPIANTO_SEDE_1      ( Misc.nh(request.getParameter("srcDescTipoImpiantoSede1")));
      ...
      data_InventariAnag.setDESC_TIPO_RETE_SEDE_2          ( Misc.nh(request.getParameter("srcDescTipoReteSede2")));
      data_InventariAnag.setDESC_TIPO_IMPIANTO_SEDE_2      ( Misc.nh(request.getParameter("srcDescTipoImpiantoSede2")));
