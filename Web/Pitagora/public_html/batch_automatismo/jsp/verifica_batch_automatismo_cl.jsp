...
<%=StaticMessages.getMessage(3006,"verifica_batch_automatismo_cl.jsp")%>
</logtag:logData>
...
String strNameFirstPage = "verifica_batch_automatismo_cl.jsp";
strTitle = "Verifica Batch Automatismo OF-PS";
strCodeFunz = StaticContext.RIBES_TOOL_AUTOMATISMO;
strImageTitle =StaticContext.PH_TOOL_PREF_BATCH_AUTOMATISMO_IMAGES;
%>
