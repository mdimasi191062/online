...
<%=StaticMessages.getMessage(3006,"lista_fornitori_cl.jsp")%>
</logtag:logData>
<%
...
function ONCONFERMA()
{
  if (document.frmDati.CodSel.length==0){  
     ...
     document.frmDati.action="ins_fornitore_cl.jsp"
...
<TITLE>Selezione Fornitore</TITLE>
</HEAD>
...
<%
   vettore = remoto_FILTRO_MOV_NON_RICEJB.FindAll(codiceTipoContratto);      
   if (!(vettore==null || vettore.size()==0)) {
        vettArray = (DatiForn[]) vettore.toArray( new DatiForn[1]);
        session.setAttribute( "vettArray", vettArray);
   }else{        
        session.setAttribute( "vettArray", null);
   }  
  }
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
				<tr>
					<td>
					  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
              <tr>
                <td bgcolor="#0A6B98" class="white" valign="top" width="91%">&nbsp;Lista Fornitori</td>
...
<form name="frmSearch" onsubmit="submitFrmSearch('0');return false" method="post" action="lista_fornitori_cl.jsp">
  <tr>
    <td>
            ...
            <table border="0" width="90%" cellspacing="0" cellpadding="1" bgcolor="#0A6B98" align="center">
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
                  <tr>
                    <td bgcolor="#0A6B98" class="white" valign="top" width="91%">&nbsp;Fornitori selezionati</td>
                    <td bgcolor="#FFFFFF" class="white" align="center" width="9%"><img src="../../common/images/body/quad_blu.gif"></td>
                  </tr>
                  </table>
                </td>
                    ...
                    <tr>
                      <td>
                        ...
                        <tr>
                          ...
                          <td width="100%" bgcolor='#D5DDF1' class="textB" >Fornitore</td>
                        </tr>
...
<%
      ...
      {
         DatiForn datiforn = vettArray[j];
         if ((i%2)==0)
          bgcolor="#EBF0F0";
         else
          bgcolor="#CFDBE9";
         String CODE_FORNITORE            = datiforn.get_codice();                                                    
         String DESC_FORNITORE            = datiforn.get_descrizione();
           if(CodSel==j)
           {
              sChecked="checked";
           }
...
%>
                        <TR>
                           ...
                           <TD bgcolor='<%=bgcolor%>' class='text'><%= DESC_FORNITORE %></TD>
                        </tr>
                        <tr>
