...
<%=StaticMessages.getMessage(3006,"lista_classi_cl.jsp")%>
</logtag:logData>
<%
...
<title>Lista Classi Oggetto di Fatturazione</title>
...
function ONCONFERMA()
{
  if (document.frmDati.CodSel.length==0){ 
     ...
     document.frmDati.action="ins_classe_cl.jsp"
...
<TITLE>Selezione Classe Oggetto di Fatturazione</TITLE>
</HEAD>
...
<%
   vettore = remoto_FILTRO_MOV_NON_RICEJB.FindClass();
   if (!(vettore==null || vettore.size()==0)) 
   {
        vettArray = (DatiClass[]) vettore.toArray( new DatiClass[1]);
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
				<tr>
					<td>
					  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
              <tr>
                <td bgcolor="#0A6B98" class="white" valign="top" width="91%">&nbsp;Lista Classi Oggetto di Fatturazione</td>
...
<form name="frmSearch" onsubmit="submitFrmSearch('0');return false" method="post" action="lista_classi_cl.jsp">
  <tr>
    <td>
            ...
            <table border="0" width="90%" cellspacing="0" cellpadding="1" bgcolor="#0A6B98" align="center">
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
                  <tr>
                    <td bgcolor="#0A6B98" class="white" valign="top" width="91%">&nbsp;Classi Oggetto di Fatturazione selezionati</td>
                    <td bgcolor="#FFFFFF" class="white" align="center" width="9%"><img src="../../common/images/body/quad_blu.gif"></td>
                  </tr>
                  </table>
                </td>
                    ...
                    <tr>
                      <td>
                        ...
                        <tr>
                          ...
                          <td bgcolor='#D5DDF1' class="textB" width="100%">Classi Oggetto di Fatturazione</td>
                        </tr>
...
<%
      ...
      {
         DatiClass DatiClass = vettArray[j];
         if ((i%2)==0)
          bgcolor="#EBF0F0";
         else
          bgcolor="#CFDBE9";
         String CODE_CLASSE            = DatiClass.get_codice();                                                    
         String DESC_CLASSE            = DatiClass.get_descrizione();
           if(CodSel==j)
           {
              sChecked="checked";
           }
...
%>
                        <TR>
                           ...
                           <TD bgcolor='<%=bgcolor%>' class='text'><%= DESC_CLASSE %></TD>
                        </tr>
                        <tr>
