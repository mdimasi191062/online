...
<%=StaticMessages.getMessage(3006,"cbn1_canc_mnr_cl.jsp")%>
</logtag:logData>
<%
...
<title>Cancellazione movimenti non ricorrenti</title>
...
function ONELIMINA()
{  
    if (confirm('Si vuole confermare l\'operazione di cancellazione?')==true)
     {
       document.frmSearch.submit();
     }
}
</SCRIPT>
<TITLE>Cancellazione Movimento</TITLE>
</HEAD>
<BODY>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
				<tr>
					<td>
					  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
              <tr>
                <td bgcolor="#0A6B98" class="white" valign="top" width="91%">&nbsp;Cancellazione Movimenti non Ricorrenti</td>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#CFDBE9">
                    ...
                    <tr>
                      <td class="textB" align="right">Classe Oggetto di Fatturazione:</td>
                    ...
                    <tr>
                      <td class="textB" align="right">Oggetto di fatturazione:</td>
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#CFDBE9">
              ...
              <tr>
                <td class="textB" align="right" width="30%">Data transazione:</td>
              ...
              <tr>
                <td class="textB" align="right">Descrizione:</td>
              ...
              <tr>
                <td class="textB" align="right">Importo:</td>
              ...
              <tr>
                <td class="textB" align="right">Data Fatturabilità:</td>
              ...
              <tr>
                ...
                <td  class="text" align="right" width="10%">&nbsp;<%=anno%></td>
              </tr>   
              <tr>
                <td colspan='4' class="textB" align="right">&nbsp;</td>
              </tr>
