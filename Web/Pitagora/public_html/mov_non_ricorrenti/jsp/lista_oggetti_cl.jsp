...
<%=StaticMessages.getMessage(3006,"lista_oggetti_cl.jsp")%>
</logtag:logData>
<%
...
<title>Lista Oggetti di Fatturazione</title>
...
function ONCONFERMA()
{
  if (document.frmDati.CodSel.length==0){ 
     ...
     document.frmDati.action="ins_oggetto_cl.jsp"
...
<TITLE>Selezione Oggetto di Fatturazione</TITLE>
</HEAD>
...
<%
   String codclas = request.getParameter("txtCodeClasse");
   vettore = remoto_FILTRO_MOV_NON_RICEJB.FindOgg(codclas);
   if (!(vettore==null || vettore.size()==0)) 
   {
        vettArray = (DatiOgg[]) vettore.toArray( new DatiOgg[1]);
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
				<tr>
					<td>
					  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
              <tr>
                <td bgcolor="#0A6B98" class="white" valign="top" width="91%">&nbsp;Lista Oggetti di Fatturazione</td>
...
<form name="frmSearch" onsubmit="submitFrmSearch('0');return false" method="post" action="lista_oggetti_cl.jsp">
  <tr>
    <td>
...
<tr>
          <td>
            ...
            <table border="0" width="90%" cellspacing="0" cellpadding="1" bgcolor="#0A6B98" align="center">
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
                  <tr>
                    <td bgcolor="#0A6B98" class="white" valign="top" width="91%">&nbsp;Oggetti di Fatturazione selezionati</td>
                    <td bgcolor="#FFFFFF" class="white" align="center" width="9%"><img src="../../common/images/body/quad_blu.gif"></td>
                  </tr>
                  </table>
                </td>
                    ...
                    <tr>
                      <td>
                        ...
                        <tr>
                          ...
                          <td bgcolor='#D5DDF1' class="textB" width="100%">Oggetti di Fatturazione</td>
                        </tr>
...
<%
      ...
      {
         DatiOgg DatiOgg = vettArray[j];
         if ((i%2)==0)
          bgcolor="#EBF0F0";
         else
          bgcolor="#CFDBE9";
         String CODE_OGGETTO            = DatiOgg.get_codice();                                                    
         String DESC_OGGETTO            = DatiOgg.get_descrizione();
         java.util.Date DATA_VALID      = DatiOgg.get_data_inizio();
           if(CodSel==j)
           {
              sChecked="checked";
           }
...
%>
                        <TR>
                           ...
                           <TD bgcolor='<%=bgcolor%>' class='text'><%= DESC_OGGETTO %></TD>
                        </tr>
                        <tr>
