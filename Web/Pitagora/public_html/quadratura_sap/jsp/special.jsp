...
<%=StaticMessages.getMessage(3006,"special.jsp")%>
</logtag:logData>
    ...
    /*if ( strCodeServizio != null && !"".equals(strCodeServizio)) 
      ...
      */  
      if ( strCicloVal != null && !"".equals(strCicloVal)) 
            aRemote2=remoteCtr_Utility.getQuadratureSapSpecial(strTipoExport,strCicloVal);
...
function exportCsv(typeExport){
  ...
  openDialog("stampa_quadratSapSpe.jsp", 30, 50, " ,scrollbars=1, resizable=1, toolbar=0, status=0, menubar=1");
}
...
<form name="frmSearch" onsubmit="submitFrmSearch('0');return false" method="post" action="special.jsp">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
        <tr>
            <td>
              <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
                  <tr>
                    <td bgcolor="#0A6B98" class="white" valign="top" width="91%">&nbsp;Quadratura SAP Special</td>
