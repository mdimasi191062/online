                     ...
                     <td  class="textB" align="left">&nbsp Ciclo di fatturazione:</td>
                          ...
                          <%
                            ...
                            if ((oggfatt!=null)&&(oggfatt.size()!=0))
                              {// Visualizzo elementi
                              %>
                               <select class="text" title="Combo ciclo Fatturazione" name="comboCicloF" onFocus="" onchange="carPeriodi();">
                       ...
                       <td  class="text" align="right"> &nbsp <input type=text class="text" size=23 name="ciclo" value=""> </td>
                    ...
                    <table width="50%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="textB" nowrap align="left">
                         Solo popolamento: <input type=checkbox name=soloPopolamento value="N" onclick="impostaSoloPopolamento();">&nbsp;&nbsp;
                        </td>
                        <td class="textB" nowrap align="left">
                         Solo scarti: <input type=checkbox name=soloScarti value="0" onclick="impostaSoloScarti();">&nbsp;&nbsp;
                        </td>
                        <td class="textB" nowrap align="left">
                         Genera Report: <input type=checkbox name=generaReport value="0">&nbsp;&nbsp;
                        </td>
                        <td class="textB" nowrap align="left">
