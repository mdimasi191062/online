...
<%=StaticMessages.getMessage(3006,"VerificaVAAbortSp.jsp")%>
</logtag:logData>
<%
...
function ONCONTINUA(){
    document.abortForm.action="VerificaVASp.jsp" ;
    document.abortForm.submit();  
}
</SCRIPT>
...
<%
   if (typeLoad!=0)
   {
    ...
    oggAbort = homeVerificaAbort.findAll(cod_contratto);
    if (oggAbort!=null)
       session.setAttribute("oggAbort", oggAbort);
%>

<form name="abortForm" method="get" action="VerificaVAAbortSp.jsp">
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorRigaDispariTabella%>">
                    ...
                    <tr>
                      <td class="textB" colspan =2 align="center"> Per i seguenti account la relativa fattura non è stata congelata.</td>
                    </tr>
                    <tr>
                      <td colspan =2>&nbsp;</td>
                    </tr>
...
<%
    ...
    {
    response.sendRedirect(request.getContextPath()+"/valorizza_attiva/jsp/VerificaVASp.jsp?des_contratto="+ java.net.URLEncoder.encode(des_contratto,com.utl.StaticContext.ENCCharset)+"&cod_contratto="+cod_contratto);
%>
