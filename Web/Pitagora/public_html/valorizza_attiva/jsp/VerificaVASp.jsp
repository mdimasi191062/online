...
<%=StaticMessages.getMessage(3006,"VerificaVASp.jsp")%>
</logtag:logData>
...
{
    document.verificaForm.action="VALstAccElabSp.jsp" ;
    document.verificaForm.submit();
}
function ONAGGIORNA(){
    document.verificaForm.typeLoad.value="0";
    document.verificaForm.action="VerificaVASp.jsp" ;
    document.verificaForm.submit();  
}
</SCRIPT>
...
//System.out.println(">>>>>>>>>flagTipoContr VerificaVASp "+flagTipoContr);
     /*  String codFunz=null;
       if(cod_contratto.equals(StaticContext.ULL) || cod_contratto.equals(StaticContext.NP) || cod_contratto.equals(StaticContext.CPS) 
                                   || cod_contratto.equals(StaticContext.COLOCATION))
             codFunz=StaticContext.INFR_BATCH_VAL_ATTIVA_SP;//23
       else
             codFunz=StaticContext.INFR_BATCH_VAL_ATTIVA_XDSL;//21
             
    oggAbort = homeVA.findLstVer(codFunz,cod_contratto);
    */
...
<form name="verificaForm" method="get" action="VerificaVASp.jsp">
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorRigaDispariTabella%>">
                    ...
                    <tr>
                      <td width="50%" class="textB" align="left">&nbsp; Verifica Batch Valorizzazione attiva : &nbsp;</td>
                    </tr>
                    <tr>
