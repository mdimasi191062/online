...
function onCaricaSelectAccount(dati)
{
  ...
  ElencoFile(codeFunz,codeCiclo,codeServizio,tipoBatch,flagSys,codeAccount,tipoFile,tipoDett,pathReport,pathReportStorici,estensione_file,estensione_file_storico)
}
...
function ElencoFile(codeFunz,codeCiclo,codeServizio,tipoBatch,flagSys,codeAccount,tipoFile,tipoDett,pathReport,pathReportStorici,estensione_file,estensione_file_storico)
{
...
function onCaricaSelectElencoFile(dati)
{
  ...
  //riempiSelect('comboDisponibili',dati);
}
