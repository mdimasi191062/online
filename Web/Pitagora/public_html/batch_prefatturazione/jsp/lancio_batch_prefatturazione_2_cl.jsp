...
<%=StaticMessages.getMessage(3006,"lancio_batch_prefatturazione_2_cl.jsp")%>
</logtag:logData>
...
<%	String strCodiceFasePrefatturazione = Misc.nh(request.getParameter("chkBatchPref"));
	...
	<% 	strLogMessage = "remoteCtr_Batch.LancioBatch_Pref:(pstr_CodiceFunzionalitaRibes:" + StaticContext.RIBES_TOOL_PREFATTURAZIONE + ";CodeUtente=" + strCodeUtente + ";)";%>
	<logtag:logData id="<%= ((clsInfoUser)session.getAttribute(StaticContext.ATTRIBUTE_USER)).getUserName() %>">
			<%=StaticMessages.getMessage(3501,strLogMessage)%>
	</logtag:logData>
	<%
	lstr_Messagge = remoteCtr_Batch.LancioBatch_Pref (strCodiceFasePrefatturazione,
                          								 strCodeUtente);
...
<BODY onload="initialize()">
	<form name="frmDati" action="lancio_batch_prefatturazione_2_cl.jsp" method="post">
