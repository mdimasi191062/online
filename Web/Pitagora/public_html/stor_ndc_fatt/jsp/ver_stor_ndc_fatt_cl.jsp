...
<%=StaticMessages.getMessage(3006,"ver_stor_ndc_fatt_cl.jsp")%>
</logtag:logData>
...
String strNameFirstPage = "ver_stor_ndc_fatt_cl.jsp";
strTitle = "Verifica Batch Export per Sap";
strCodeFunz = StaticContext.RIBES_STORICIZ_NDC_FATT;
strImageTitle =StaticContext.PH_STORICIZ_NDC_FATT_IMAGES;
%>
	...
	<tr>
		<td>
		 <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
			<tr>
			  <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">Verifica Batch Storicizzazione Ndc e Fatt</td>
