...
<%=StaticMessages.getMessage(3006,"lancio_stor_ndc_fatt_2_cl.jsp")%>
</logtag:logData>
...
<%	
    String strTipoContratto = Misc.nh(request.getParameter("codiceTipoContratto"));
	String strCodeTipoStor = Misc.nh(request.getParameter("rdTipoStoricizzazione"));
	...
	<% 	strLogMessage = "remoteCtr_Batch.LancioStoricizzazione(strTipoContratto : "+strTipoContratto+";strCodeTipoStor : "+strCodeTipoStor+";strCodeAccount : "+strCodeAccount+";strCodeUtente : " + strCodeUtente + ")";%>
	<logtag:logData id="<%= ((clsInfoUser)session.getAttribute(StaticContext.ATTRIBUTE_USER)).getUserName() %>">
			<%=StaticMessages.getMessage(3501,strLogMessage)%>
	</logtag:logData>
	<%
	lstr_Messagge = remoteCtr_Batch.LancioStoricizzazione(strTipoContratto,
														 strCodeTipoStor,
														 strCodeAccount,
	                                                     strCodeUtente);
	...
	<tr>
		<td>
		 <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
			<tr>
			  <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">Lancio Batch Storicizzazione NDC e Fatt</td>
