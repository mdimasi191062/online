...
<%=StaticMessages.getMessage(3006,"cbn1_vis_listino_cl.jsp")%>
</logtag:logData>
<%
	int intFunzionalita;
	...
	switch (intAction){
		case StaticContext.LIST:
			strIntestazione="Listino Tariffario";
		break;
	}
%>
<HTML>
...
function initialize()
{
	...
	Enable(objForm.chkStoricoTariffe);
}
...
// MODIFICA DEL 27/04/2004
			//objForm.action="cbn1_vis_listino_2_cl.jsp";
       //     objForm.submit();
     var URLstringa = "cbn1_vis_listino_2_cl.jsp?viewStateRicerca=" + objForm.viewStateRicerca.value ;
...
function popolaviewState(){
	...
	//Code Ass Disattive
	if(objForm.chkStoricoTariffe.checked == true){
		updVS(objForm.viewStateRicerca,"vsRicMostraStoricoTariffe","S");
	}else{
		updVS(objForm.viewStateRicerca,"vsRicMostraStoricoTariffe","N");
	}
}
//MODIFICA DEL 28/04/2004
function CancellaPs()
    ...
    <td>
      ...
      <tr>
        ...
        <td width="72%" class="text">
          ...
          <input class="text" title="P/S" type="button"  name="cmdPS" value="..." onClick="selezionaPs();">
           <%//MODIFICA DEL 28/04/2004%>
	  ...
	  <tr>
        <td height="30" width="28%" class="textB">&nbsp;</td>
		<td height="30" width="72%" class="text">
			<input type="checkbox" name="chkStoricoTariffe" value="N">&nbsp;Mostra Storico Tariffe
		</td>
	  </tr>
    </table>
    </td>
