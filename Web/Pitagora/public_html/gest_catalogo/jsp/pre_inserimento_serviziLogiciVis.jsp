...
<%=StaticMessages.getMessage(3006,"pre_inserimento_serviziLogiciVis.jsp")%>
</logtag:logData>
...
<%
  ...
  String esito = "";
  String messaggio = "";
  DB_PreServiziLogici servizioLogico;
  
  String codeServLogico = Misc.nh(request.getParameter("strCodeServLogico"));
  String descServLogico = Misc.nh(request.getParameter("strDescServLogico"));
  String descBreve = Misc.nh(request.getParameter("strDescBreve"));
  ...
  if(!codeServLogico.equals("") && intAggiornamento != 0){
    servizioLogico = new DB_PreServiziLogici();
    servizioLogico.setCODE_SERVIZIO_LOGICO(codeServLogico);
    servizioLogico.setDESC_SERVIZIO_LOGICO(descServLogico);
    servizioLogico.setDESC_BREVE(descBreve);
    servizioLogico.setCODE_SERVIZIO(codeServ);
    servizioLogico.setFLAG_MODIF(strFlagModificaDescrizione);

    /* INSERIMENTO */    
    if(intAggiornamento == 1){
      esito = entCatalogo.insServizioLogico(servizioLogico);
      if(esito.equals("")){
        messaggio = "Inserimento nuovo Servizio Logico effettuato correttamente.";
      }else{
        messaggio = esito;
      }
    }
    ...
    /* AGGIORNAMENTO */
      ...
      esito = entCatalogo.aggiorna_servizio_logico(servizioLogico);     
      if(esito.equals("")){
        messaggio = "Aggiornamento Servizio Logico effettuato correttamente.";
      }else{
        messaggio = esito;
      }
    }
    ...
    /* CANCELLAZIONE */
      ...
      esito = entCatalogo.cancella_servizio_logico(servizioLogico.getCODE_SERVIZIO_LOGICO());     
      if(esito.equals("")){
        messaggio = "Cancellazione Servizio Logico effettuato correttamente.";
      }else{
        messaggio = esito;
      }
    }
  ...
  String strServLogico = Misc.nh(request.getParameter("txtServLogico"));
  String strDescServLogico = Misc.nh(request.getParameter("txtDescServLogico"));  
  String strDescBreve = Misc.nh(request.getParameter("txtDescBreve"));  
  String strServ = Misc.nh(request.getParameter("txtServ"));  
  
  if(strServLogico.equals(""))
    strServLogico = "%";
  if(strDescServLogico.equals(""))
    strDescServLogico = "%";
  if(strDescBreve.equals(""))
    strDescBreve = "%";
  if(strServ.equals(""))
    strServ = "%";    
  ...
  {
    accountVector = entCatalogo.getServiziLogiciFiltro(strServLogico,strDescServLogico,strDescBreve,strServ);
...
function submitRicerca(typeLoad)
{
  var stringa="";
  var stringa2="";
  stringa=objForm.txtServLogico.value;
  stringa2=objForm.txtDescServLogico.value;
  stringa3=objForm.txtDescBreve.value;
  stringa4=objForm.txtServ.value;  
  objForm.txtServLogico.value=stringa.toUpperCase();
  objForm.txtDescServLogico.value=stringa2.toUpperCase();
  objForm.txtDescBreve.value=stringa3.toUpperCase();
  objForm.txtServ.value=stringa4.toUpperCase();  
  objForm.hidTypeLoad.value = "0";
  document.frmDati.intAggiornamento.value = '0';
  objForm.action = "pre_inserimento_serviziLogiciVis.jsp";
  objForm.submit();
}
...
function ONAGGIUNGI() {
  var URL = '';
  URL='pre_inserimento_serviziLogici.jsp';
  openCentral(URL,'Servizi_Logici','directories=no,location=no,menubar=no,resizable=no,scrollbars=yes,status=no,toolbar=no',600,400);
}

function ONAGGIORNA() {
  var URL = '';
  URL='pre_aggiornamento_serviziLogici.jsp?code_servizio_logico='+document.frmDati.strCodeServLogico.value;
  openCentral(URL,'Servizi_Logici','directories=no,location=no,menubar=no,resizable=no,scrollbars=yes,status=no,toolbar=no',600,400);
}

function ONCANCELLA() {
  if(confirm("Attenzione!!! Si vuole procedere con la cancellazione del Servizio Logico selezionato?")){
...
function ONMODIFICADESC() {
  var URL = '';
  URL='pre_aggiornamento_serviziLogici.jsp?code_servizio_logico='+document.frmDati.strCodeServLogico.value + '&modifica_descrizione=1';
...
function setCodeHidden(obj){
  ...
  document.frmDati.strCodeServLogico.value=obj.value;
}
...
<input type="hidden" name="strDescServLogico" value="">
<input type="hidden" name="strDescBreve" value="">
<input type="hidden" name="strCodeServ" value="">
<input type="hidden" name="strFlagModificaDescrizione" value="">  
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
				<tr>
					<td>
					  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
						<tr>
						  <td bgcolor="#0A6B98" class="white" valign="top" width="91%">&nbsp;Servizi Logici</td>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorTabellaGenerale%>">
                    ...
                    <tr>
                      <td width="20%" class="textB" align="right">Codice:&nbsp;</td>
                      <%
                      if(strServLogico.equals("%"))
                        strServLogico = "";
                      %>
                      <td width="20%" class="text"><input class="text" type='text' name='txtServLogico' value='<%=strServLogico%>' size='15'></td>
                      <td width="20%" class="textB" align="right" nowrap>Descrizione:&nbsp;</td>
                      <%
                      if(strDescServLogico.equals("%"))
                        strDescServLogico = "";
                      %>
                      <td width="20%" class="text"><input class="text" type='text' name='txtDescServLogico' value='<%=strDescServLogico%>' size='15'></td>                  
                    ...
                    <tr>
                      <td width="20%" class="textB" align="right" nowrap>Descrizione Breve:&nbsp;</td>
                      <%
                      if(strDescBreve.equals("%"))
                        strDescBreve = "";
                      %>
                      <td width="20%" class="text"><input class="text" type='text' name='txtDescBreve' value='<%=strDescBreve%>' size='15'></td>
                      <td width="20%" class="textB" align="right" nowrap>Servizio Fisico:&nbsp;</td>
                      <%
                      if(strServ.equals("%"))
                        strServ = "";
                      %>
                      <td width="20%" class="text"><input class="text" type='text' name='txtServ' value='<%=strServ%>' size='15'></td>                   
                    </tr>
                    <tr>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
                          <tr>
                            <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Servivi Logici Selezionati</td>
                            <td bgcolor="<%=StaticContext.bgColorCellaBianca%>" class="white" align="center" width="9%"><img src="<%=StaticContext.PH_COMMON_IMAGES%>quad_blu.gif"></td>
                          </tr>
                        </table>
                      </td>
                      ...
                      <td>
                        <table width="100%" align='center' border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td bgcolor="<%=StaticContext.bgColorTestataTabella%>" class="textB">Desc Breve </td>
                            <td bgcolor="<%=StaticContext.bgColorTestataTabella%>" class="textB">Servizio Fisico</td>
                          </tr>
                          <tr>
                            <td colspan='8' bgcolor="<%=StaticContext.bgColorCellaBianca%>"><img src="<%=StaticContext.PH_COMMON_IMAGES%>pixel.gif" width="1" height='2'></td>
                          </tr>
                          ...
                          for(j=((pagerPageNumber.intValue()-1)*intRecXPag);((j < intRecTotali) && (j < pagerPageNumber.intValue()*intRecXPag));j++)	
                          {
                            ...
                            myelement=(DB_PreServiziLogici)accountVector.elementAt(j);
                            ...
                            if(myelement.getTIPO_SISTEMA_MITTENTE() != null && myelement.getTIPO_SISTEMA_MITTENTE().equals("S")){
                             ...
                             //curSubClassRow_new = curSubClassRow;
                            }else{
                          ...
                          <tr class="<%=curSubClass_Row%>">
                            <TD width="10">
                              <input type="radio" name="CodeFunz" value="<%=myelement.getCODE_SERVIZIO_LOGICO()%>" onClick="setCodeHidden(this);">
                              <input type="hidden" name="tipo_sistema_mittente_<%=myelement.getCODE_SERVIZIO_LOGICO()%>" value="<%=myelement.getTIPO_SISTEMA_MITTENTE()%>">
                            </TD>
                            <td><%=myelement.getCODE_SERVIZIO_LOGICO()%></td>
                            <td><%=myelement.getDESC_SERVIZIO_LOGICO()%></td>
                            <td><%=myelement.getDESC_BREVE()%></td>
                            <td><%=myelement.getCODE_SERVIZIO()%></td>
                          </tr>
                          <tr>
                            <td colspan='8' bgcolor="<%=StaticContext.bgColorCellaBianca%>"><img src="<%=StaticContext.PH_COMMON_IMAGES%>pixel.gif" width="1" height='2'></td>
                          </tr>
