...
<%
   ...
   Vector vct_Info = remoteEnt_Catalogo.getVisualizzaInfo( Elemento,  "",  strCodeServizio,  "",  "" , "" );
...
<body>
 <table ALIGN=center>
      <tr>
         <td bgcolor="#0a6b98" class="white" valign="top" width="91%"> Servizio Dati Dettaglio</td>
      </tr>
 </table>
 <TABLE ALIGN=center BORDER=10 CELLPADDING=5 CELLSPACING=5 WIDTH=200 HEIGHT=9>
        <tr>
            <TD  class="textB" > Il Servizio <%=info_Compo.getDATO_ESERCIZIO().equals("N")?"non":""%> è in esercizio </TD>
        </tr>
</TABLE> 
</body>
</HTML>