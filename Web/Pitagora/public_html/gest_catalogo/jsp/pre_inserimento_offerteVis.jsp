...
<%
  ...
  String esito = "";
  String messaggio = "";
  DB_CAT_Offerta newOfferta;
  
  String codeOff = Misc.nh(request.getParameter("strCodeOff"));
  String descOff = Misc.nh(request.getParameter("strDescOff"));
  String divOff = Misc.nh(request.getParameter("strDIVOff"));
  String dfvOff = Misc.nh(request.getParameter("strDFVOff"));
  String tipologiaOff = Misc.nh(request.getParameter("strTipologiaOff"));
  String classeOff = Misc.nh(request.getParameter("strClasseOff"));
  String valRecOff = Misc.nh(request.getParameter("strValRecOff"));
  ...
  if(!codeOff.equals("") && intAggiornamento != 0){
    newOfferta = new DB_CAT_Offerta();
    newOfferta.setCODE_OFFERTA(codeOff);
    newOfferta.setDESC_OFFERTA(descOff);
    newOfferta.setDATA_INIZIO_VALID(divOff);
    newOfferta.setDATA_FINE_VALID(dfvOff);
    newOfferta.setTIPO_OFF(tipologiaOff);
    newOfferta.setVAL_REC(valRecOff);  
    newOfferta.setCODE_GRUPPI_CLASS_OFF(classeOff);
    newOfferta.setFLAG_MODIF(strFlagModificaDescrizione);

    /* INSERIMENTO */    
    if(intAggiornamento == 1){
      esito = offerte.insOfferta(newOfferta);
      if(esito.equals("")){
        messaggio = "Inserimento nuova Offerta effettuato correttamente.";
      }else{
        messaggio = esito;
      }
    }
    ...
    /* AGGIORNAMENTO */
      ...
      esito = offerte.aggiorna_offerta(newOfferta);
      if(esito.equals("")){
        messaggio = "Aggiornamento Offerta effettuato correttamente.";
      }else{
        messaggio = esito;
      }
    }
    ...
    /* CANCELLAZIONE */
      ...
      esito = offerte.cancella_offerta(codeOff);
      if(esito.equals("")){
        messaggio = "Cancellazione Offerta effettuato correttamente.";
      }else{
        messaggio = esito;
      }
    }
  ...
  {
    accountVector = offerte.getOfferteFiltro(strAccount,strDescAccount);
...
function submitRicerca(typeLoad)
{
  ...
  objForm.action = "pre_inserimento_offerteVis.jsp";
  objForm.submit();
}
...
function ONMODIFICADESC() {
  var URL = '';
  URL='pre_aggiornamento_offerte.jsp?code_offerta='+document.frmDati.strCodeOff.value + '&modifica_descrizione=1';
...
function setCodeHidden(obj){
  ...
  document.frmDati.strCodeOff.value=obj.value;
}
...
<input type="hidden" name="strCodeOff" value="">
<input type="hidden" name="strDescOff" value="">
<input type="hidden" name="strDIVOff" value="">
<input type="hidden" name="strDFVOff" value="">
<input type="hidden" name="strTipologiaOff" value="">
<input type="hidden" name="strClasseOff" value="">
<input type="hidden" name="strValRecOff" value="">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
				<tr>
					<td>
					  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#0A6B98">
						<tr>
						  <td bgcolor="#0A6B98" class="white" valign="top" width="91%">&nbsp;Offerte</td>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorTabellaGenerale%>">
                    ...
                    <tr>
                      <td width="20%" class="textB" align="right">Codice Offerta:&nbsp;</td>
                      <%
                      if(strAccount.equals("%"))
                        strAccount = "";
                      %>
                      <td width="20%" class="text"><input class="text" type='text' name='txtAccount' value='<%=strAccount%>' size='15'></td>
                      <td width="20%" class="textB" align="right" nowrap>Descrizione Offerta:&nbsp;</td>
                      <%
                      if(strDescAccount.equals("%"))
                        strDescAccount = "";
                      %>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
                          <tr>
                            <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Offerte Selezionati</td>
                            <td bgcolor="<%=StaticContext.bgColorCellaBianca%>" class="white" align="center" width="9%"><img src="<%=StaticContext.PH_COMMON_IMAGES%>quad_blu.gif"></td>
                          </tr>
                        </table>
                      </td>
                      ...
                      <td>
                        <table width="100%" align='center' border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td bgcolor="<%=StaticContext.bgColorTestataTabella%>" class="textB">Data Inizio Validità </td>
                            <td bgcolor="<%=StaticContext.bgColorTestataTabella%>" class="textB">Data Fine Validità </td>
                            <td bgcolor="<%=StaticContext.bgColorTestataTabella%>" class="textB">Tipologia Offerte </td>
                            <td bgcolor="<%=StaticContext.bgColorTestataTabella%>" class="textB">Classe Offerta </td>
                            <td bgcolor="<%=StaticContext.bgColorTestataTabella%>" class="textB">Val. % Rec. </td>
                          </tr>
                          <tr>
                            <td colspan='8' bgcolor="<%=StaticContext.bgColorCellaBianca%>"><img src="<%=StaticContext.PH_COMMON_IMAGES%>pixel.gif" width="1" height='2'></td>
                          </tr>
                          ...
                          <tr class="<%=curSubClass_Row%>">
                            <TD width="10">
                              <input type="radio" name="CodeFunz" value="<%=myelement.getCODE_OFFERTA()%>" onClick="setCodeHidden(this);">
                              <input type="hidden" name="tipo_sistema_mittente_<%=myelement.getCODE_OFFERTA()%>" value="<%=myelement.getTIPO_SISTEMA_MITTENTE()%>">
                            </TD>
                            <td><%=myelement.getCODE_OFFERTA()%></td>
                            <td><%=myelement.getDESC_OFFERTA()%></td>
                            <td><%=myelement.getDATA_INIZIO_VALID()%></td>
                            <td><%=myelement.getDATA_FINE_VALID()%></td>
                            <td><%=myelement.getTIPO_OFF()%></td>
                            <td><%=myelement.getCODE_GRUPPI_CLASS_OFF()%></td>
                            <td><%=myelement.getVAL_REC()%></td>
                          </tr>
                          <tr>
                            <td colspan='8' bgcolor="<%=StaticContext.bgColorCellaBianca%>"><img src="<%=StaticContext.PH_COMMON_IMAGES%>pixel.gif" width="1" height='2'></td>
                          </tr>
