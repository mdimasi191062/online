...
<%
   ...
   Vector vct_Info = remoteEnt_Catalogo.getVisualizzaInfo( Elemento,  strCodeOfferta,  strCodeServizio,  strCodeProdotto,  "" , "" );
...
<body>
 <table ALIGN=center>
     <tr>
     <td bgcolor="#0a6b98" class="white" valign="top" width="91%"> Prodotto Dati Dettaglio</td>
     </tr>
 </table>
 <TABLE ALIGN=center BORDER=10 CELLPADDING=5 CELLSPACING=5 WIDTH=100% HEIGHT=9>
     <tr>
    ...
    <%--<tr>
        <TD  class="textB" > Il Prodotto <%=info_Compo.getDATO_ESERCIZIO().equals("N")?"non":""%> è in esercizio </TD>
    </tr>--%>
    <tr>
    ...
    <tr>
        <TD class="textB" > Il Prodotto <%=strSpesaComplessiva%> alla Spesa Complessiva </TD>
    </tr>
</TABLE> 
</body>
</HTML>