...
<%=StaticMessages.getMessage(3006,"pre_aggiornamento_gestori.jsp")%>
</logtag:logData>
...
<%
  ...
  strTitolo="Aggiornamento Gestore";

  //Vector vctGruppiOff = null;
  //DB_Anag_Class_Off anag_class_off = null;
  String code_gestore_input = Misc.nh(request.getParameter("code_gestore"));
...
<EJB:useBean id="gestori" type="com.ejbSTL.Ent_Catalogo" scope="session">
  <EJB:createBean instance="<%=home.create()%>" />
</EJB:useBean>

<%
Vector accountVector=null;
accountVector = gestori.getPreGestori_codGest(code_gestore_input);
      ...
      <table align='center' width="95%" border="0" cellspacing="0" cellpadding="1" bgcolor="#CFDBE9">
        <tr>
          ...
          <td  class="text" align="left" colspan="2">
            <!-- MSCATENA - Aggiunta gestione flag_modifica_descrizione -->
            <input type="text" class="text" name="CodeGest" value="<%=myelement.getCODE_GESTORE()%>" <%=disabled%> maxlength="3" size="5" style="margin-left: 1px;" readonly>
          </td> 
        </tr>
        <tr>
          <td  class="textB" align="left">Descrizione:</td>
          <td  class="text" align="left" colspan="2">
            <input type="text" class="text" name="DescGest" maxlength="50" size="55" value="<%=myelement.getDESC_GESTORE()%>" onchange="uppercase(this)">
          </td>                
        </tr>
        <%--
        <tr>
        ...
        <tr>
          ...
          <td  class="text" align="left" colspan="2">
            <!-- MSCATENA - Aggiunta gestione flag_modifica_descrizione -->          
            <input type="text" class="text" name="IvaGest" value="<%=myelement.getCODE_PARTITA_IVA()%>" <%=disabled%> maxlength="16" size="18" style="margin-left: 1px;" onchange="uppercase(this)">
          </td> 
        </tr>
        <tr>
          ...
          <td  class="text" align="left" colspan="2">
            <!-- MSCATENA - Aggiunta gestione flag_modifica_descrizione -->          
            <input type="text" class="text" size=12 maxlength="12" name="dataIni" title="dataIni" value="<%=myelement.getDATA_INIZIO_VALID()%>" onblur="handleblur('data_ini');" readonly <%=disabled%>>
