...
<head>
	...
	<SCRIPT LANGUAGE='Javascript'>
		...
		function initialize()
        {
			...
			setObjProp(objForm.txtDataCreazione,"label=Data Creazione|tipocontrollo=data|obbligatorio=si|disabilitato=si");			
		...
		function ONLANCIOBATCH()
		{
			if(validazioneCampi(objForm))
			{
				...
				objForm.action = "lancio_rep_swn_2_cl.jsp";
				objForm.submit();
			}
			...
			<tr>
				<td>
				  <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
					<tr>
					  <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">&nbsp;Lancio Repricing Consuntivo swn</td>
			...
			<tr>
				<td align="center" colspan="2">
					...
					<tr>
						...
						<tr>
							<td class="textB">Data Creazione</td>
							<td class="textB">&nbsp;</td>
						</tr>
						<tr>
							<td class="text">
								<input type='text' name='txtDataCreazione' value='<%=strDataCreazione%>' class="text" readonly="">
								<a href="javascript:showCalendar('frmDati.txtDataCreazione','');" onMouseOver="javascript:showMessage('seleziona'); return true;" onMouseOut="status='';return true"><img name='imgCalendar2' src="<%=StaticContext.PH_COMMON_IMAGES%>calendario.gif" border="0"></a>
								<a href="javascript:clearField(objForm.txtDataCreazione);" onMouseOver="javascript:showMessage('cancella');  return true;" onMouseOut="status='';return true"><img name='imgCancel2'   src="<%=StaticContext.PH_COMMON_IMAGES%>cancella.gif"   border="0"></a>
							</td>
							<td class="text">&nbsp;</td>
					      </tr>
						</table>
