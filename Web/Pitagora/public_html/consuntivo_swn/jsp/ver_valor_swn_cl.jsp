...
<%=StaticMessages.getMessage(3006,"ver_valor_swn_cl.jsp")%>
</logtag:logData>
...
String strNameFirstPage = "ver_valor_swn_cl.jsp";
strTitle = "Verifica Valorizzazione Cons. Swn";
strCodeFunz = StaticContext.RIBES_LANCIO_PKG;
strCodeFunzPkg = StaticContext.PKG_VAL_CONSUNTIVO;
