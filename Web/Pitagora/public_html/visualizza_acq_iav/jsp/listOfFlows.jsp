...
if(request.getParameterValues("checkbox_download") != null && request.getParameter("button").equals("Download")){
   ...
   // dlg.setVisible(loader);
   //String startDate, String endDate, String code, String area
    pathZip = visualizzaAcqIav.generateFileCSVFromFluxName( selectedForDownloads, startDate , endDate, paramCode, area);
    System.out.println("PAHT:" + pathZip);
    
      if(pathZip != null && !pathZip.equals("")){
    
    String nameFIle = paramCode + "_" + area + "_ACQ_" + startDate.replace("/","_") + "_" + endDate.replace("/","_") + ".zip";
    ...
    <td> 
      <table class="paginated" width="100%" align='center' border="0" cellspacing="0" cellpadding="0">
            ...
            <tr> 
              ...
              <th bgcolor='#D5DDF1' class="textB" width="25%">Nome Flusso</th>
              <th bgcolor='#D5DDF1' class="textB" width="25%">Record Acquisiti</th>
              <th bgcolor='#D5DDF1' class="textB" width="25%">Record Non Acquisiti</th>
              <th bgcolor='#D5DDF1' class="textB" width="25%">Area Acquisizione</th>
            </tr>
            </thead>
