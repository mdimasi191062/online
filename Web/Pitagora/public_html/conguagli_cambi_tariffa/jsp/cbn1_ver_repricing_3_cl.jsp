...
<%=StaticMessages.getMessage(3006,"cbn1_ver_repricing_3_cl.jsp")%>
</logtag:logData>
...
<HEAD>
	...
	<script language="JavaScript">
		...
		function ONANNULLA(){
			...
			objForm.action = "cbn1_ver_repricing_2_cl.jsp";
			objForm.submit();
...
<form name="frmDati" action="cbn1_ver_repricing_3_cl.jsp">
  ...
  <%if(strPageAction.equals(""))
			...
			<table width="50%" align='center' border="0" cellspacing="0" cellpadding="0">
				<tr>
                     <td class="textB" align="left" bgcolor="<%=StaticContext.bgColorTestataTabella%>">
					 	Risultati per pag.:&nbsp;
						<select class="text" name="cboNumRecXPag" onchange="reloadPage('1','cbn1_ver_repricing_3_cl.jsp');">
	...
	if(strPageAction.equals("CONGELA"))
	{
		//estrazione del code utente loggato dalla sessione
			...
			String strLogMessage = "remoteCtr_Repricing.congela(" + "CodeTipoContratto=" + lstr_CodeTipoContratto
		  ...
		  <%
			...
			strResult = remoteCtr_Repricing.congela (lstr_CodeTipoContratto,
                                               strCodeUtente,
