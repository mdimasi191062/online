...
<%=StaticMessages.getMessage(3006,"cbn1_ver_repricing_2_cl.jsp")%>
</logtag:logData>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function Initialize()
	{
        ...
        {%>
		  ...
		  strURL+="&strCodeFunz=<%=StaticContext.RIBES_INFR_BATCH_CAMBI_TARIFFA%>";
	...
	function ONCONGELA_TUTTI(){
		if(window.confirm("<%=remoteEnt_AnagraficaMessaggi.getAnagraficaMessaggi(StaticContext.LIST,"3112")%>")){
			...
			var strURL="<%=StaticContext.PH_CONGUAGLICAMBITARIFFA_JSP%>cbn1_ver_repricing_3_cl.jsp";
	...
	function ONVISUALIZZA_SCARTI(){
		...
		strURL+="&hidCodeFunz=<%=StaticContext.RIBES_INFR_BATCH_CAMBI_TARIFFA%>";
	...
	<tr>
		<td>
		 <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="<%=StaticContext.bgColorHeader%>">
			<tr>
			  <td bgcolor="<%=StaticContext.bgColorHeader%>" class="white" valign="top" width="91%">Verifica batch calcolo conguagli cambi tariffa: <%=request.getParameter("hidDescTipoContratto")%></td>
		...
		<td width='100%' colspan='3'>
			<table >
				<tr>
                      ...
                      <td  class="text">
                        <select class="text" name="cboNumRecXPag" onchange="reloadPage('1','cbn1_ver_repricing_2_cl.jsp');">
