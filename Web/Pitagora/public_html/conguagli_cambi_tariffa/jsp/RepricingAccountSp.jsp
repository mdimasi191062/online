...
<sec:ChkUserAuth RedirectEnabled="true" VectorName="RepricingAccountSp1" />
<logtag:logData id="<%= ((clsInfoUser)session.getAttribute(StaticContext.ATTRIBUTE_USER)).getUserName() %>">
<%=StaticMessages.getMessage(3006,"RepricingAccountSp.jsp")%>
</logtag:logData>
<%
...
/*if(controllo.equals("csv"))
  ...
  testo="Per i seguenti account non è stato generato il CSV o non è stata congelata la Fattura/Nota di Credito. Proseguire escludente gli account individuati?";
...
<form name="AccountForm" method="get" action="RepricingAccountSp.jsp">
...
<%
 ...
 {    
     ...
     if(flagTipoContr.equals("0"))
              oggAccount = homeAccount2Lst.findAccountLstRPC(code_elab);
      //else
              //oggAccount = homeAccount2Lst.findAccountLstXDSLNC(code_elab);
 } 
...
%>
  ...
  <tr>
    <td>
        <sec:ShowButtons PageName="RepricingAccountSp" />
    </td>
  </tr>
</TABLE>   
</form>
