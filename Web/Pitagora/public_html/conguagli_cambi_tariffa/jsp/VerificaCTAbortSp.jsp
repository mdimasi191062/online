...
<%=StaticMessages.getMessage(3006,"VerificaCTAbortSp.jsp")%>
</logtag:logData>
<%
...
function ONCONTINUA(){
    document.abortForm.action="VerificaRepricingSp.jsp" ;
    document.abortForm.submit();  
}
</SCRIPT>
...
<form name="abortForm" method="get" action="VerificaCTAbortSp.jsp">
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=StaticContext.bgColorRigaDispariTabella%>">
                    ...
                    <tr>
                      <td class="textB" colspan =2 align="center">Per i seguenti account il relativo Cambio Tariffa non è stato congelato.</td>
                    </tr>
                    <tr>
                      <td colspan =2>&nbsp;</td>
                    </tr>
...
<%
    ...
    {
    response.sendRedirect(request.getContextPath()+"/conguagli_cambi_tariffa/jsp/VerificaRepricingSp.jsp?des_tipo_contr="+ java.net.URLEncoder.encode(des_tipo_contr,com.utl.StaticContext.ENCCharset)+"&cod_tipo_contr="+cod_tipo_contr);
%>
